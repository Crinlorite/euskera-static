...
level: a1
order: 1
title: Díes de la selmana y actividaes
estimatedMinutes: 9
covers:
- days-of-week
- common-verbs
...
- id: ex-eg-mc1
  ...
  - igandea
  answer: 0
  explanation: '*Astelehena* — primer día de la selmana (lliteralmente "primer-día-de-la-selmana").'
- id: ex-eg-mc2
  type: multiple-choice
  prompt: ¿Qué día ye "asteburua"?
  options:
  - llunes
  - martes
  - fin de selmana (sábadu-domingu)
  - miércoles
  answer: 2
  explanation: '*Asteburua* — fin de selmana, lliteralmente "el final de la selmana".'
- id: ex-eg-fb1
  type: fill-in-blank
  prompt: '"Voi al ximnasiu el llunes" = ___ kiroldegira noa.'
  answers:
  - Astelehenean
  - astelehenean
  explanation: '*-(e)an* nos díes = "el". *Astelehenean* — "el llunes".'
- id: ex-eg-fb2
  type: fill-in-blank
  prompt: '"Tolos llunes" = ___'
  answers:
  - astelehenero
  - Astelehenero
  explanation: 'El sufixu *-ero* indica "cada / tolos": *astelehenero* = "tolos llunes".'
- id: ex-eg-fc
  type: flashcards
  cards:
  - eu: astelehena
  ...
  - eu: ostiralean
    es: el vienres
  - eu: asteburuan
    es: la fin de selmana
  - eu: astelehenero
    es: tolos llunes
  - eu: egunero
    es: cada día / tolos díes
- id: ex-eg-mp
  type: match-pairs
  pairs:
  - eu: astelehena
...
| Euskera | Asturianu | Pista |
|---|---|---|
| *astelehena* | llunes | aste + lehen = "primer día de la selmana" |
| *asteartea* | martes | aste + arte = "ente selmana" |
| *asteazkena* | miércoles | aste + azken = "últimu día de la selmana llaboral" (hist.) |
| *osteguna* | xueves | egun = día |
| *ostirala* | vienres | comparte la raíz *ortzi/osti-* (cielu) con *osteguna* |
| *larunbata* | sábadu | larun + bata |
| *igandea* | domingu | día festivu históricu |
