...
level: a1
order: 5
title: La mio selmana (lleición integradora)
estimatedMinutes: 12
covers: [weekly-planning, future-koGo, time-when, days-of-week, common-verbs]
exercises:
  - id: ex-nast-mc1
    type: multiple-choice
    prompt: '"Mañana diré al ximnasiu" =…'
    options: ['Bihar kiroldegira joan naiz', 'Bihar kiroldegira joango naiz', 'Bihar kiroldegian nago', 'Kiroldegira bihar dut']
    answer: 1
    explanation: 'Futuru: *joan + go = joango* + *naiz* (yo). *Kiroldegira* = al ximnasiu (sufixu -ra de destín).'
  - id: ex-nast-mc2
    type: multiple-choice
    prompt: '"El sábadu quedaré con Maialen pa tomar café" =…'
    ...
    answer: 0
    explanation: '*Larunbatean* (el sábadu) + *Maialenekin* (con Maialen) + *geratuko naiz* (quedaré) + *kafea hartzeko* (pa tomar café).'
  - id: ex-nast-fb1
    type: fill-in-blank
    prompt: '"La selmana que vien tendré exámenes" = ___ astean azterketak izango ditut.'
    answers: [Datorren]
    explanation: '*Datorren* — "que vien". *Datorren astean* — "la selmana que vien".'
  - id: ex-nast-fb2
    type: fill-in-blank
    prompt: '"El vienres saldré colos amigos" = Ostiralean lagunekin atera___ naiz.'
    answers: [ko]
    explanation: '*Atera* + *ko* + *naiz* = *aterako naiz* (saldré). Verbu en -a → -ko.'
  - id: ex-nast-fc
    type: flashcards
    cards:
      - { eu: agenda, es: axenda }
      ...
      - { eu: 'Bilera dut hamarretan', es: Tengo reunión a les diez }
      - { eu: 'Libre zaude?', es: '¿Tas llibre?' }
      - { eu: 'Geratuko gara?', es: '¿Quedamos?' }
  - id: ex-nast-mp
    type: match-pairs
    pairs:
      - { eu: 'datorren astean', es: la selmana que vien }
      - { eu: 'asteburuan', es: el fin de selmana }
      - { eu: 'bihar', es: mañana }
...
| Verbu | Forma futura | Asturianu |
|---|---|---|
| joan | joango naiz/da | diré, dirá |
| etorri | etorriko naiz/da | vendré, vendrá |
| egon | egongo naiz | taré |
| izan | izango da | será / habrá |
| ikusi | ikusiko dut | (lo) veré |
| egin | egingo dut | (lo) faré |
| jan | jango dut | (lo) comeré |
| lan egin | lan egingo dut | trabayaré |
