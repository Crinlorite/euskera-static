...
level: a1
order: 1
title: Les habitaciones de la casa
estimatedMinutes: 10
covers:
- home-rooms
exercises:
...
- id: ex-09-01-mc1
  ...
  prompt: Quies duchate. ¿A qué habitación vas?
  options:
  - sukaldea
  - logela
  - komuna
  - egongela
  answer: 2
  explanation: '"Komuna" ye''l bañu (la habitación cola ducha, llavabu, etc.).'
- id: ex-09-01-mc2
  type: multiple-choice
  prompt: '"Egongela" ye...'
  options:
  ...
  - la terraza
  answer: 2
  explanation: '"Egongela" componse de "egon" (tar) + "gela" (sala) — la sala onde se ta, el salón.'
- id: ex-09-01-fb1
  type: fill-in-blank
  prompt: 'Dormimos na ___ (en castellanu: dormitoriu).'
  answers:
  - logela
  explanation: '"Logela" = "lo" (suañu) + "gela" (sala).'
- id: ex-09-01-fc
  type: flashcards
  cards:
  - eu: etxea
  ...
  - eu: igogailua
    es: ascensor
  - eu: solairua
    es: planta / pisu (nivel del edificiu)
  - eu: Zenbat logela ditu?
    es: ¿Cuántos dormitorios tien?
  - eu: Non dago sukaldea?
    es: ¿Ónde ta la cocina?
---
...
|---|---|
| *etxea* | la casa |
| *pisua* | el pisu (vivienda nun edificiu) |
...
| *egongela* | salón |
| *sarrera* | entrada |
| *korridorea* / *pasabidea* | pasiellu |
| *balkoia* | balcón |
| *terraza* | terraza |

## Cómo se formen dellos nomes

L'euskera ye perclaru con estes pallabres. Si mires cómo tán compuestes, recuérdesles meyor:

- **logela** → *lo* (suañu) + *gela* (sala) = "sala del suañu" → dormitoriu
- **egongela** → *egon* (tar) + *gela* = "sala d'estar" → salón
- **sukaldea** → *su* (fueu) + *aldea* (zona) = "zona del fueu" → cocina
