...
level: a1
order: 1
title: Laguna, bizilaguna y otres rellaciones
estimatedMinutes: 10
...
exercises:
  - id: ex-10-01-mp
    type: match-pairs
    pairs:
      - { eu: laguna, es: amigu/a }
      - { eu: bizilaguna, es: vecín/a }
      - { eu: ikaskidea, es: compañeru/a de clase }
      - { eu: lankidea, es: compañeru/a de trabayu }
      - { eu: ezaguna, es: conocíu/a }
      - { eu: koadrila, es: cuadriella / grupu d'amigos }
  - id: ex-10-01-mc1
    type: multiple-choice
    prompt: "¿Quién ye'l to \"bizilaguna\"?"
    options: [El to hermanu, El to xefe, El to vecín, El to profesor]
    answer: 2
    explanation: '"Bizi" (vivir) + "laguna" (compañeru/a) = "compañeru/a de vivienda" → vecín/a (del to portal o barriu).'
  - id: ex-10-01-mc2
    type: multiple-choice
    prompt: '"Lankidea" componse de…'
    options: ["lan (trabayu) + kide (compañeru)", "lan (trabayu) + idea (idea)", "la + nike (suerte)", "lan (muncho) + kide (familiar)"]
    answer: 0
    explanation: '"Lan" (trabayu) + "kide" (miembru/compañeru) = "compañeru de trabayu".'
  - id: ex-10-01-fb1
    type: fill-in-blank
    prompt: 'La mio cuadriella = nire ___.'
    answers: [koadrila]
    explanation: '"Koadrila" ye préstamu del castellán "cuadrilla", y n''Euskal Herria ye central na vida social.'
  - id: ex-10-01-fc
    type: flashcards
    cards:
      - { eu: laguna, es: amigu/a }
      - { eu: lagun mina, es: amigu/a íntimu/a }
      - { eu: bizilaguna, es: vecín/a }
      - { eu: auzokidea, es: vecín/a (del barriu) }
      - { eu: auzoa, es: barriu }
      - { eu: ikaskidea, es: compañeru/a de clase }
      - { eu: lankidea, es: compañeru/a de trabayu }
      - { eu: ezaguna, es: conocíu/a }
      - { eu: ezezaguna, es: desconocíu/a }
      - { eu: koadrila, es: cuadriella }
      - { eu: koadrilakide, es: miembru de la cuadriella }
      - { eu: bikotekidea, es: pareya }
      - { eu: nire ondoko bizilaguna, es: el mio vecín/a d'al llau }
      - { eu: gazteen koadrila, es: la cuadriella de los mozos }
---
