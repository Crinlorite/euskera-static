...
exercises:
  - id: ex-10-02-mp
    ...
    pairs:
      ...
      - { eu: medikua, es: médicu/a }
      - { eu: erizaina, es: enfermeru/a }
      - { eu: sukaldaria, es: cocineru/a }
      - { eu: kazetaria, es: periodista }
  - id: ex-10-02-mc1
    type: multiple-choice
    prompt: ¿Quién ye un "polizia"?
    options: [Un médicu, Un policía, Un periodista, Un cocineru]
    answer: 1
  ...
  - id: ex-10-02-mc2
    ...
    options: [enfermos, llibros, coches, neños]
    answer: 2
  ...
  - id: ex-10-02-fc
    ...
    cards:
      ...
      - { eu: dendaria, es: dependiente/a }
      - { eu: zerbitzaria, es: camareru/a }
      - { eu: mekanikaria, es: mecánicu/a }
      - { eu: idazlea, es: escritor/a }
      - { eu: abokatua, es: abogáu/a }
      - { eu: arkitektoa, es: arquitectu/a }
      - { eu: igeltseroa, es: albañil }
      - { eu: nekazaria, es: agricultor/a }
      - { eu: arrantzalea, es: pescador/a }
      - { eu: langilea, es: trabayador/a }
      - { eu: jubilatua, es: xubiláu/a }
      - { eu: langabea, es: en paru / desemplegáu/a }
      - { eu: 'Zer da zure lanbidea?', es: '¿Cuála ye la to profesión?' }
      - { eu: 'Zertan egiten duzu lan?', es: '¿En qué trabayes?' }
---
