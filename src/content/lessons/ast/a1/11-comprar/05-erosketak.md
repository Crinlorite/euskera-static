...
- *Sagar**rik** ba al duzue?* — ¿Tenéis mazanes?
- *Esne**rik** behar dugu.* — Necesitamos lleche.

Y pa dicir que NUN hai:

- *Ez dago ogi**rik**.* — Nun hai pan.
- *Ez daukat sagar**rik**.* — Nun tengo mazanes.

> El partitivu `-rik` úsase siempre con cantidaes indefiníes y en negación. La forma del productu va ensin artículu (*ogi**rik***, non *ogiarik*).
