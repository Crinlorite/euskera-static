...
level: a1
order: 4
title: Cantidaes y midíes (neurriak)
estimatedMinutes: 10
covers:
- quantities-units
- numbers-1-100
...
- id: ex-neur-mc1
  ...
  prompt: '"Un quilu de mazanes" n''euskera ye…'
  options:
  - Sagar bat
  - Kilo bat sagar
  - Bat sagar kilo
  - Kiloa bat sagar
  answer: 1
  explanation: 'N''euskera la cantidá va **enantes** y el productu va ensin artículu: *kilo bat sagar*.'
- id: ex-neur-mc2
  type: multiple-choice
  prompt: '"Una docena de güevos" dizse…'
  options:
  - Arrautza dozena
  - Arrautza bat dozena
  - Dozena bat arrautza
  - Dozena arrautzak
  answer: 2
  explanation: '"*Dozena bat*" sigue''l mesmu patrón que *kilo bat*: cantidá + productu ensin artículu.'
- id: ex-neur-fb1
  type: fill-in-blank
  prompt: '"Mediu quilu de tomate" = kilo ___ tomate.'
  answers:
  - erdi
  explanation: '*Kilo erdi* — "mediu quilu". *Erdi* (mediu) va DETRÁS de la unidá, al revés que n''asturianu.'
- id: ex-neur-fb2
  type: fill-in-blank
  prompt: '"Más" n''euskera (pa pidir un poco más na tienda) = ___.'
  answers:
  - gehiago
  - Gehiago
  explanation: '*Gehiago* (más) y *gutxiago* (menos) son los dos comparativos básicos pa regular cantidaes.'
- id: ex-neur-fc
  type: flashcards
  cards:
  - eu: kilo bat
