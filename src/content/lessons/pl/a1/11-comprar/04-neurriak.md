...
- id: ex-neur-mc1
  ...
  prompt: '"Kilogram jabłek" po baskijsku to…'
  options:
  - Sagar bat
  - Kilo bat sagar
  - Bat sagar kilo
  - Kiloa bat sagar
  answer: 1
  explanation: 'W języku baskijskim ilość stoi **przed**, a produkt jest bez rodzajnika: *kilo bat sagar*.'
- id: ex-neur-mc2
  type: multiple-choice
  prompt: '"Tuzin jaj" mówi się…'
  options:
  - Arrautza dozena
  - Arrautza bat dozena
  - Dozena bat arrautza
  - Dozena arrautzak
  answer: 2
  explanation: '"*Dozena bat*" stosuje ten sam wzorzec co *kilo bat*: ilość + produkt bez rodzajnika.'
- id: ex-neur-fb1
  type: fill-in-blank
  prompt: '"Pół kilo pomidorów" = kilo ___ tomate.'
  answers:
  - erdi
  explanation: '*Kilo erdi* — "pół kilo". *Erdi* (pół) stoi ZA jednostką, odwrotnie niż w języku polskim.'
- id: ex-neur-fb2
  type: fill-in-blank
  prompt: '"Więcej" po baskijsku (aby poprosić o trochę więcej w sklepie) = ___.'
  answers:
  - gehiago
  - Gehiago
  explanation: '*Gehiago* (więcej) i *gutxiago* (mniej) to dwa podstawowe słowa służące do określania ilości.'
- id: ex-neur-fc
  type: flashcards
  cards:
  - eu: kilo bat
...
> **Uwaga:** produkt występuje **bez rodzajnika** (*sagar*, nie *sagarra*). To ważna zasada, którą opanujesz w praktyce.
...
- *Hori da, nahikoa da.* — Zgadza się, wystarczy.
...
> **Notatka kulturowa:** na targach (*azoka*) i tradycyjnych placach wciąż wszystko waży się "na oko": prosisz o *kilo bat sagar*, a sprzedawca doważa produkt do żądanej wagi. Często słychać *pixka bat gehiago, mesedez*, gdy wskazówka wagi się podnosi.
