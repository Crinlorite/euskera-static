...
exercises:
  ...
  - id: ex-noiz-mc2
    ...
    answer: 1
    explanation: '*Etzi* — dopodomani. È una parola corta e molto utile.'
  - id: ex-noiz-fb1
    type: fill-in-blank
    prompt: '"La settimana prossima" = ___ astean.'
    answers: [Datorren, datorren]
    explanation: '*Datorren* — "quello/quella che viene" (letteralmente: "che viene"). *Datorren astean* è la forma standard.'
  - id: ex-noiz-fb2
    type: fill-in-blank
  ...
  - id: ex-noiz-fc
    ...
    cards:
      ...
      - { eu: 'datorren astean', es: la settimana prossima }
      - { eu: 'datorren astelehenean', es: lunedì prossimo }
      - { eu: 'datorren urtean', es: l'anno prossimo }
      - { eu: asteburuan, es: il fine settimana }
