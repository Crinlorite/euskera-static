...
level: a1
order: 4
title: Quando? Marcatori temporali (gaur, atzo, gaur goizean)
estimatedMinutes: 10
...
exercises:
  - id: ex-04-nm-mc1
    ...
    options: ["domani pomeriggio", "ieri pomeriggio", "questo pomeriggio", "proprio adesso"]
    answer: 1
    explanation: '"Atzo" = ieri; "arratsaldean" = di pomeriggio. Insieme: "ieri pomeriggio".'
  - id: ex-04-nm-mc2
    type: multiple-choice
    prompt: 'Vuoi dire "Stamattina ho fatto colazione a casa". Come lo dici?'
    options:
    ...
    answer: 1
    explanation: '"Gaur goizean" = "oggi di mattina / stamattina". E poiché è passato recente, "gosaldu dut" senza -tzen.'
  - id: ex-04-nm-mc3
    type: multiple-choice
    prompt: 'Distingui: "askotan" vs "behin". Cosa vogliono dire?'
    options:
      - "askotan = una volta; behin = spesso"
      - "askotan = mai; behin = sempre"
      - "askotan = spesso; behin = una volta"
      - "Le due significano la stessa cosa"
    answer: 2
    explanation: '"Askotan" = spesso, molte volte. "Behin" = una volta (di solito accompagna azioni puntuali).'
  - id: ex-04-nm-fb1
    type: fill-in-blank
    prompt: 'Dopodomani = ___ (completa la parola).'
    answers: [etzi, Etzi]
    explanation: '"Etzi" = dopodomani. La catena temporale: atzo (ieri) → gaur (oggi) → bihar (domani) → etzi (dopodomani).'
  - id: ex-04-nm-mp
    type: match-pairs
    pairs:
      - { eu: gaur, es: oggi }
      - { eu: atzo, es: ieri }
      - { eu: bihar, es: domani }
      - { eu: etzi, es: dopodomani }
      - { eu: gaur goizean, es: stamattina }
      - { eu: gaur arratsaldean, es: questo pomeriggio }
      - { eu: atzo gauean, es: ieri notte }
      - { eu: orain, es: adesso }
      - { eu: lehen, es: prima }
  - id: ex-04-nm-fc
    type: flashcards
    cards:
      ...
      - { eu: lehen, es: prima }
      - { eu: gero, es: 'poi, dopo' }
      - { eu: gaur goizean, es: stamattina / oggi di mattina }
      - { eu: gaur eguerdian, es: oggi a mezzogiorno }
      - { eu: gaur arratsaldean, es: questo pomeriggio }
      - { eu: gaur gauean, es: stanotte }
      - { eu: atzo goizean, es: ieri mattina }
      - { eu: atzo arratsaldean, es: ieri pomeriggio }
      - { eu: atzo gauean, es: ieri notte }
      - { eu: aste honetan, es: questa settimana }
      - { eu: behin, es: una volta }
      - { eu: bi aldiz, es: due volte }
      - { eu: oraintxe, es: proprio adesso }
---
