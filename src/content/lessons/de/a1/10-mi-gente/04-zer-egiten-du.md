...
level: a1
order: 4
title: Was macht er/sie? — Über die Routine anderer sprechen
estimatedMinutes: 12
covers:
...
- id: ex-10-04-mc1
  ...
  prompt: Wie sagt man „Er/sie arbeitet im Krankenhaus“?
  options:
  ...
  answer: 0
  explanation: „Ospitalean“ = im Krankenhaus (Lokativ -ean), „lan egiten du“ = er/sie arbeitet (3. Person).
- id: ex-10-04-fb1
  type: fill-in-blank
  prompt: Er/sie wohnt in Pamplona = Iruñean ___ da.
  answers:
  - bizi
  explanation: '„Bizi da“ = er/sie wohnt (wörtlich: „ist am Wohnen“). Für die 1. Person wäre es „bizi naiz“.'
- id: ex-10-04-mc2
  type: multiple-choice
  prompt: „Bera euskaltegian lan egiten du“ — zu welchem Beruf passt das am besten?
  options:
  - sukaldaria
  - irakaslea
  - mekanikaria
  - zerbitzaria
  answer: 1
  explanation: Wenn jemand in einem Euskaltegi arbeitet, ist er/sie höchstwahrscheinlich Lehrer/in (irakaslea).
- id: ex-10-04-fb2
  type: fill-in-blank
  prompt: Er/sie ist 40 Jahre alt = Berrogei urte ___.
  answers:
  - ditu
  explanation: „Ditu“ = er/sie hat (3. Person, Objekt im Plural — die Jahre werden im Plural gezählt).
- id: ex-10-04-fc
  type: flashcards
  cards:
  - eu: Zer egiten du?
  ...
  - eu: Non lan egiten du?
    es: Wo arbeitet er/sie?
  - eu: Bera medikua da
    es: Er/sie ist Arzt/Ärztin
  - eu: Ospitalean lan egiten du
    es: Er/sie arbeitet im Krankenhaus
  - eu: Eskolan lan egiten du
    es: Er/sie arbeitet in der Schule
  - eu: Tabernan lan egiten du
    es: Er/sie arbeitet in der Bar
  - eu: Bulegoan lan egiten du
    es: Er/sie arbeitet im Büro
  - eu: Iruñean bizi da
    es: Er/sie wohnt in Pamplona
  - eu: Hogeita hamar urte ditu
    es: Er/sie ist 30 Jahre alt
  - eu: Ezkonduta dago
    es: Er/sie ist verheiratet
  - eu: Ezkongabea da
    es: Er/sie ist ledig
  - eu: Bi seme-alaba ditu
    es: Er/sie hat zwei Kinder
  - eu: Bakarrik bizi da
    es: Er/sie wohnt allein
  - eu: Lagunekin bizi da
    es: Er/sie wohnt mit seinen/ihren Freunden
---
...
| Zusammenleben | *Bera **bikotekidearekin bizi da**.* — Er/sie wohnt mit seinem/ihrem Partner. |
| Alter | *Bera**k hogeita hamar urte ditu**.* — Er/sie ist 30 Jahre alt. |
| Beruf | *Bera **medikua da**.* — Er/sie ist Arzt/Ärztin. |
| Arbeit | *Bera**k ospitalean lan egiten du**.* — Er/sie arbeitet im Krankenhaus. |
...
| Ort | Satz |
|---|---|
| ospitala (Krankenhaus) | *ospitale**an** lan egiten du* |
| eskola (Schule) | *eskola**n** lan egiten du* |
| taberna (Bar) | *taberna**n** lan egiten du* |
| bulegoa (Büro) | *bulego**an** lan egiten du* |
| denda (Geschäft) | *denda**n** lan egiten du* |
| euskaltegia (Euskara-Sprachschule) | *euskaltegi**an** lan egiten du* |
| etxean (zu Hause) | *etxean lan egiten du* |

> Denk daran: Wenn das Wort auf ein organisches `-a` endet (tabern**a**), bleibt es erhalten → *tabernan*. Wenn es auf einen Konsonanten endet (Madril), wird ein `-e-` eingefügt → *Madrilen*.

## Beruf + Ort = vollständiges Porträt

Die Kombination von Beruf und Ort macht die Vorstellung eines Nachbarn stimmig:
