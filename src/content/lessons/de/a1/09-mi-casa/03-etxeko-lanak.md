...
exercises:
  - id: ex-09-03-mp
    type: match-pairs
    pairs:
      - { eu: garbitu, es: putzen }
      - { eu: prestatu, es: vorbereiten }
      - { eu: jaso, es: aufräumen }
      - { eu: lisatu, es: bügeln }
      - { eu: erosketak egin, es: einkaufen }
      - { eu: zaborra atera, es: den Müll rausbringen }
  - id: ex-09-03-mc1
    type: multiple-choice
    prompt: 'Wie sagt man "das Geschirr spülen"?'
    options: [arropa lisatu, ohea jantzi, ontziak garbitu, lurra erratu]
    answer: 2
    explanation: '"Ontziak garbitu" (wörtlich "das Geschirr reinigen") = spülen. Man sagt auch "harrikoa egin".'
  - id: ex-09-03-mc2
    type: multiple-choice
    prompt: '"Ohea jantzi" bedeutet...'
    options: [das Bett machen, das Bett abziehen, ein Bett kaufen, die Laken waschen]
    answer: 0
    explanation: '"Jantzi" bedeutet anziehen/anlegen; "ohea jantzi" = das Bett machen.'
  - id: ex-09-03-fb1
    type: fill-in-blank
    prompt: 'Ich putze das Bad = Nik komuna ___.'
    answers: [garbitzen dut]
    explanation: 'Für eine gewohnheitsmäßige Handlung verwenden wir `-tzen` + Hilfsverb (Präsens): "garbitzen dut" = ich putze.'
  - id: ex-09-03-fc
    type: flashcards
    cards:
      - { eu: etxeko lanak, es: die Hausarbeit }
      - { eu: garbitu, es: putzen }
      - { eu: prestatu, es: vorbereiten }
      - { eu: jaso, es: aufräumen }
      - { eu: lisatu, es: bügeln }
      - { eu: ohea jantzi, es: das Bett machen }
      - { eu: ontziak garbitu, es: das Geschirr spülen }
      - { eu: harrikoa egin, es: spülen (Ausdruck) }
      - { eu: arropa lisatu, es: die Wäsche bügeln }
      - { eu: arropa zabaldu, es: die Wäsche aufhängen }
      - { eu: zaborra atera, es: den Müll rausbringen }
      - { eu: erosketak egin, es: einkaufen }
      - { eu: xurgagailua pasa, es: staubsaugen }
      - { eu: bazkaria prestatu, es: das Essen zubereiten }
      - { eu: txakurra paseatu, es: den Hund ausführen }
      - { eu: 'Nork egiten du?', es: '¿Wer macht es?' }
      - { eu: egunero, es: jeden Tag }
      - { eu: astean behin, es: einmal pro Woche }
---
