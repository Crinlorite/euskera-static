...
level: a1
order: 2
title: Mesele zilei (otorduak)
estimatedMinutes: 10
covers: [meals]
exercises:
  - id: ex-otr-mc1
    type: multiple-choice
    prompt: '"Bazkaria" înseamnă…'
    options: [micul dejun, masa de prânz, gustarea de după-amiază, cina]
    answer: 1
    explanation: '*bazkaria* este masa principală de la prânz.'
  - id: ex-otr-mc2
    type: multiple-choice
    prompt: 'Cum se spune "gustarea de la jumătatea dimineții" (pauza de la ora 11)?'
    options: [gosaria, hamaiketakoa, bazkaria, afaria]
    answer: 1
    explanation: '*hamaiketakoa* (literal: "cea de la ora unsprezece") este acea gustare de la jumătatea dimineții, un obicei foarte bască.'
  - id: ex-otr-fb1
    type: fill-in-blank
    prompt: 'A mânca (verb) = ___.'
    answers: [jan]
    explanation: '*jan* = a mânca. Forma de bază a infinitivului.'
  - id: ex-otr-fb2
    type: fill-in-blank
    prompt: 'A bea (verb) = ___.'
    answers: [edan]
    explanation: '*edan* = a bea.'
  - id: ex-otr-fc
    type: flashcards
    cards:
      - { eu: gosaria, es: micul dejun }
      - { eu: hamaiketakoa, es: gustarea de la jumătatea dimineții }
      - { eu: bazkaria, es: masa (de prânz) }
      - { eu: askaria, es: gustarea de după-amiază }
      - { eu: afaria, es: cina }
      - { eu: otordua, es: masa (generic) }
      - { eu: jan, es: a mânca }
      - { eu: edan, es: a bea }
      - { eu: gosaldu, es: a lua micul dejun }
      - { eu: bazkaldu, es: a lua masa (la prânz) }
      - { eu: afaldu, es: a cina }
      - { eu: gose naiz, es: mi-e foame }
      - { eu: egarri naiz, es: mi-e sete }
  - id: ex-otr-mp
    type: match-pairs
    pairs:
      - { eu: gosaria, es: mic dejun }
      - { eu: hamaiketakoa, es: gustare de la jumătatea dimineții }
      - { eu: bazkaria, es: masa de prânz }
      - { eu: askaria, es: gustare de după-amiază }
      - { eu: afaria, es: cină }
      - { eu: jan, es: a mânca }
      - { eu: edan, es: a bea }
---
