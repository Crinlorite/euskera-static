...
level: a1
order: 5
title: Săptămâna mea (lecție integratoare)
estimatedMinutes: 12
covers: [weekly-planning, future-koGo, time-when, days-of-week, common-verbs]
exercises:
  - id: ex-nast-mc1
    type: multiple-choice
    prompt: '"Mâine voi merge la sala de sport" =…'
    options: ['Bihar kiroldegira joan naiz', 'Bihar kiroldegira joango naiz', 'Bihar kiroldegian nago', 'Kiroldegira bihar dut']
    answer: 1
    explanation: 'Viitor: *joan + go = joango* + *naiz* (eu). *Kiroldegira* = la sala de sport (sufixul -ra de destinație).'
  - id: ex-nast-mc2
    type: multiple-choice
    prompt: '"Sâmbătă mă voi întâlni cu Maialen ca să bem o cafea" =…'
    ...
    answer: 0
    explanation: '*Larunbatean* (sâmbătă) + *Maialenekin* (cu Maialen) + *geratuko naiz* (mă voi întâlni) + *kafea hartzeko* (ca să bem o cafea).'
  - id: ex-nast-fb1
    type: fill-in-blank
    prompt: '"Săptămâna viitoare voi avea examene" = ___ astean azterketak izango ditut.'
    answers: [Datorren]
    explanation: '*Datorren* — "care vine". *Datorren astean* — "săptămâna viitoare".'
  - id: ex-nast-fb2
    type: fill-in-blank
    prompt: '"Vineri voi ieși cu prietenii" = Ostiralean lagunekin atera___ naiz.'
    answers: [ko]
    explanation: '*Atera* + *ko* + *naiz* = *aterako naiz* (voi ieși). Verb în -a → -ko.'
  - id: ex-nast-fc
    type: flashcards
    cards:
      - { eu: agenda, es: agendă }
      - { eu: 'Asteko agenda', es: Agenda săptămânii }
      - { eu: 'Zer egingo duzu astelehenean?', es: Ce vei face luni? }
      - { eu: 'Kiroldegira joango naiz', es: Voi merge la sala de sport }
      - { eu: 'Lagunekin afaltzera joango gara', es: Vom merge să cinăm cu prietenii }
      - { eu: 'Asteburu honetan mendira joango gara', es: Weekendul acesta vom merge la munte }
  ...
  - id: ex-nast-mp
    type: match-pairs
    pairs:
      - { eu: 'datorren astean', es: săptămâna viitoare }
      - { eu: 'asteburuan', es: la weekend }
      - { eu: 'bihar', es: mâine }
      - { eu: 'etzi', es: poimâine }
      - { eu: 'gaur arratsaldean', es: după-amiaza aceasta }
      - { eu: 'libre nago', es: sunt liber }
---
...
| Verb | Forma de viitor | Română |
|---|---|---|
| joan | joango naiz/da | voi merge, va merge |
| etorri | etorriko naiz/da | voi veni, va veni |
| egon | egongo naiz | voi sta |
| izan | izango da | va fi / va exista |
| ikusi | ikusiko dut | (îl) voi vedea |
| egin | egingo dut | (îl) voi face |
| jan | jango dut | (îl) voi mânca |
| lan egin | lan egingo dut | voi lucra |
| atera | aterako naiz | voi ieși |
| eraman | eramango dut | (îl) voi duce |
| erosi | erosiko dut | (îl) voi cumpăra |
