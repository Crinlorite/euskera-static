...
level: a1
order: 5
title: De unde ești și unde locuiești
estimatedMinutes: 12
covers:
- origin-koa
- residence-an
...
- id: ex-05-nz-mc1
  ...
  prompt: Ce înseamnă „Nongoa zara?”
  options:
  - Cum te cheamă?
  - De unde ești?
  - Ce vârstă ai?
  - Unde locuiești?
  answer: 1
  explanation: „Nongoa” combină „non” (unde) + sufixul de proveniență.
- id: ex-05-nz-fb1
  type: fill-in-blank
  prompt: Bilbo + -koa = ___ (din Bilbao).
  answers:
  - Bilbokoa
  - bilbokoa
  explanation: Sufixul „-ko” indică proveniența/apartenența; cu articolul „-a” devine „-koa”.
- id: ex-05-nz-fb2
  type: fill-in-blank
  prompt: Locuiesc în Donostia = Donostia___ bizi naiz.
  answers:
  - n
  explanation: Pentru reședință se folosește locativul `-(e)n` („în”). Donostia + -n = Donostian (se păstrează „a” finală).
- id: ex-05-nz-mc2
  type: multiple-choice
  prompt: Cum spui „Unde locuiești?”
  options:
  - Nongoa zara?
  - Non bizi zara?
  - Nor zara?
  - Zer egiten duzu?
  answer: 1
  explanation: '„Non” înseamnă „unde”, „bizi zara” înseamnă „locuiești” — literal: „Unde locuiești?”'
- id: ex-05-nz-fc
  type: flashcards
  cards:
  - eu: Nongoa zara?
  ...
  - eu: Bilbokoa naiz
    es: Sunt din Bilbao
  - eu: Iruñekoa naiz
    es: Sunt din Pamplona
  - eu: Espainiakoa naiz
    es: Sunt din Spania
  - eu: Non bizi zara?
    es: Unde locuiești?
  - eu: Bilbon bizi naiz
    es: Locuiesc în Bilbao
  - eu: Donostian bizi naiz
    es: Locuiesc în Donostia
  - eu: Madrilen bizi naiz
    es: Locuiesc în Madrid
---
...
| Loc | Proveniență |
|---|---|
| Bilbo | Bilbo**koa** naiz (Sunt din Bilbao) |
| Donostia | Donostia**koa** naiz (Sunt din Donostia) |
| Iruñea | Iruñe**koa** naiz (Sunt din Pamplona) |
| Madril | Madril**goa** naiz |
| Espainia | Espainia**koa** naiz |
| Argentina | Argentina**koa** naiz |

> După consoană, sufixul se adaptează ortografic (*Madril* → *Madrilgoa*). Prin exercițiu, va veni de la sine.
