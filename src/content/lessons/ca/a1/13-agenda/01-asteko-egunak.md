...
| Euskera | Català | Pista |
|---|---|---|
| *astelehena* | dilluns | aste + lehen = "primer dia de la setmana" |
| *asteartea* | dimarts | aste + arte = "entre setmana" |
| *asteazkena* | dimecres | aste + azken = "últim dia de la setmana laboral" (hist.) |
| *osteguna* | dijous | egun = dia |
| *ostirala* | divendres | comparteix l'arrel *ortzi/osti-* (cel) amb *osteguna* |
...
Per datar un esdeveniment s'afegeix `-(e)an` al dia:
...
- *Astelehenean lan egiten dut.* — Treballo el dilluns.
- *Larunbatean afaltzera joango gara.* — El dissabte anirem a sopar.
...
## Asteburua — el cap de setmana

`Asteburua` (cap de setmana) és una paraula molt útil:

- *Asteburuan zer egingo duzu?* — Què faràs el cap de setmana?
