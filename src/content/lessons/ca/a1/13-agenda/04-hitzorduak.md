...
|---|---|---|
| *X-ekin geratu naiz* | *Egoitz**ekin** geratu naiz* | He quedat amb l'Egoitz |
| *X-ekin geratuko naiz* | *Egoitz**ekin** geratuko naiz* | Quedaré amb l'Egoitz |

> El sufix `-ekin` s'enganxa al nom. Si acaba en consonant s'afegeix *-ekin*: *Mikel + ekin = Mikelekin*, *Maialenekin*. Si acaba en vocal s'afegeix *-rekin*: *Garazirekin, Anerekin*.
