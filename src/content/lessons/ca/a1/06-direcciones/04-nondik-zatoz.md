...
- id: ex-nzt-mc1
  ...
  - Bilboko nator
  answer: 2
  explanation: '"Bilbo" + sufix -tik = "Bilbotik" (de Bilbao, origen del moviment).'
- id: ex-nzt-fb1
  type: fill-in-blank
  prompt: Vinc de casa = Etxe___ nator.
  answers:
  - tik
  explanation: '"Etxe" + tik = "etxetik" (de casa, origen).'
- id: ex-nzt-fb2
  type: fill-in-blank
  prompt: Venen de Madrid = Madril___ datoz.
  answers:
  - dik
  - etik
  explanation: 'Rere consonant, el sufix s''adapta: "Madril" → "Madrildik" o "Madriletik" (les dues formes s''accepten).'
- id: ex-nzt-mc2
  type: multiple-choice
  prompt: Què significa "Lanetik nator"?
  options:
  - Vaig a la feina
  - Soc a la feina
  - Vinc de la feina
  - La feina és aquí
  answer: 2
  explanation: '"Lan" + etik = "lanetik" (de la feina, origen). "Nator" = vinc (etorri sintètic).'
- id: ex-nzt-mc3
  type: multiple-choice
  prompt: 'Combina origen i destinació: "Vinc del banc i vaig al supermercat":'
  options:
  ...
  answer: 1
  explanation: NONDIK = -tik (origen, amb etorri); NORA = -ra (destinació, amb joan). Bankutik nator + supermerkatura noa.
- id: ex-nzt-fb3
  type: fill-in-blank
  prompt: 'Pregunta: D''on vens? = ___ zatoz?'
  answers:
  - Nondik
  - nondik
- id: ex-nzt-fc
...
Si a la lliçó anterior vam aprendre **NORA** (on vas), ara ve la seva parella: **NONDIK** — *d'on* vens. El sufix és **`-tik`**. Per si sol no és difícil; l'important és **no barrejar-lo** amb NORA.
...
|---|---|---|
| -a (orgànica, *eskola*) | + tik | eskola → **eskolatik** |
| Vocal sense -a final (*Bilbo*, *etxe*) | + tik | Bilbo → **Bilbotik**, etxe → **etxetik** |
| Consonant (*Madril*, *lan*) | + (e)tik o + dik | Madril → **Madriletik** / **Madrildik**; lan → **lanetik** |
...
| Pregunta | Sufix | Verb típic | Exemple |
|---|---|---|---|
| **Non?** (on?) | **-an** | egon (estar) | *Etxe**an** nago.* — Soc a casa. |
| **Nora?** (a on?) | **-ra** | joan (anar) | *Etxe**ra** noa.* — Vaig a casa. |
| **Nondik?** (d'on?) | **-tik** | etorri (venir) | *Etxe**tik** nator.* — Vinc de casa. |
...
|---|---|---|---|
| hemen | hona | **hemendik** | des d'aquí |
| hor | horra | **hortik** | des d'allà |
| han | hara | **handik** | des d'allà |
