...
level: a1
order: 1
title: Laguna, bizilaguna i altres relacions
estimatedMinutes: 10
...
exercises:
  - id: ex-10-01-mp
    type: match-pairs
    pairs:
      - { eu: laguna, es: amic/amiga }
      - { eu: bizilaguna, es: veí/veïna }
      - { eu: ikaskidea, es: company/a de classe }
      - { eu: lankidea, es: company/a de feina }
      - { eu: ezaguna, es: conegut/coneguda }
      - { eu: koadrila, es: colla / grup d'amics }
  - id: ex-10-01-mc1
    type: multiple-choice
    prompt: 'Qui és el teu "bizilaguna"?'
    options: [El teu germà, El teu cap, El teu veí, El teu professor]
    answer: 2
    explanation: '"Bizi" (viure) + "laguna" (company/a) = "company/a d''habitatge" → veí/veïna (del teu portal o barri).'
  - id: ex-10-01-mc2
    type: multiple-choice
    prompt: '"Lankidea" es compon de…'
    options: ["lan (feina) + kide (company)", "lan (feina) + idea (idea)", "la + nike (sort)", "lan (molt) + kide (familiar)"]
    answer: 0
    explanation: '"Lan" (feina) + "kide" (membre/company) = "company de feina".'
  - id: ex-10-01-fb1
    type: fill-in-blank
    prompt: 'La meva colla = nire ___.'
    answers: [koadrila]
    explanation: '"Koadrila" és un préstec del castellà "cuadrilla", i a Euskal Herria és central en la vida social.'
  - id: ex-10-01-fc
    type: flashcards
    cards:
      - { eu: laguna, es: amic/amiga }
      - { eu: lagun mina, es: amic/amiga íntim/a }
      - { eu: bizilaguna, es: veí/veïna }
      - { eu: auzokidea, es: veí/veïna (del barri) }
      - { eu: auzoa, es: barri }
      - { eu: ikaskidea, es: company/a de classe }
      - { eu: lankidea, es: company/a de feina }
      - { eu: ezaguna, es: conegut/coneguda }
      - { eu: ezezaguna, es: desconegut/desconeguda }
      - { eu: koadrila, es: colla }
      - { eu: koadrilakide, es: membre de la colla }
      - { eu: bikotekidea, es: parella }
      - { eu: nire ondoko bizilaguna, es: el meu veí/veïna del costat }
      - { eu: gazteen koadrila, es: la colla dels joves }
---
