...
level: a1
order: 4
title: Zenbat balio du? Preus i quantitats
estimatedMinutes: 11
covers:
- prices
- numbers-1-100
...
- id: ex-zbd-mc1
  ...
  - Quants n'hi ha?
  answer: 0
  explanation: '*zenbat* = quant/quants; *balio* = val/costa; *du* = "té/costa ell/ella".'
- id: ex-zbd-mc2
  type: multiple-choice
  prompt: Com es diu "vint" en basc?
  options:
  - hamar
  - hamabost
  - hogei
  - ehun
  answer: 2
  explanation: '*hogei* = 20. És la base del sistema vigesimal del basc.'
- id: ex-zbd-fb1
  type: fill-in-blank
  prompt: Costa 3 euros = ___ euro balio du.
  answers:
  - hiru
  explanation: '*hiru* = 3.'
- id: ex-zbd-fb2
  type: fill-in-blank
  prompt: Prendré dos cafès = Bi kafe ___ ___.
  answers:
  - hartuko ditut
  explanation: Per a "diverses coses" es fa servir *ditut* en lloc de *dut*.
- id: ex-zbd-fc
  type: flashcards
  cards:
  - eu: hamar
...
| Basc | Català |
|---|---|
| *Zenbat balio du?* | Quant costa? |
| *Zenbat da?* | Quant és? |
| *Zenbat dira denera?* | Quant és en total? |
| *Pagatu daiteke?* | Es pot pagar? (demanar el compte) |
...
| 50 | *berrogeita hamar* | "doble 20 i 10" |
| 60 | *hirurogei* | "tres 20" (*hiru* = tres) |
| 70 | *hirurogeita hamar* | "tres 20 i 10" |
| 80 | *laurogei* | "quatre 20" |
| 90 | *laurogeita hamar* | "quatre 20 i 10" |
| 100 | *ehun* | base |
...
>
> Un cafè sol i un entrepà. Quant és en total?
>
> — *Lau euro eta berrogeita hamar.*
>
> Quatre euros amb cinquanta.
>
> — *Tori, bost euro.*
>
> Té, cinc euros.
