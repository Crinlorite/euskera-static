...
level: a1
order: 3
title: Verbs intransitius en passat recent (joan naiz, etorri naiz)
estimatedMinutes: 12
covers:
- recent-past-naiz
- izan-nor
...
- id: ex-03-jn-mc1
  ...
  - Estic a casa
  answer: 1
  explanation: '"Joan" + "naiz" sense -tzen marca el passat recent: "he anat". El destí porta -ra: *etxera* (a casa).'
- id: ex-03-jn-mc2
  type: multiple-choice
  prompt: Per què "joan" fa servir l'auxiliar naiz i no dut?
  options:
  - Perquè comença amb J
  - Perquè és un verb intransitiu (no porta objecte)
  - Perquè és un verb irregular
  - Perquè és un verb de la primera conjugació
  answer: 1
  explanation: Els verbs sense objecte (anar, venir, despertar-se...) porten l'auxiliar izan (naiz/zara/da). Els que tenen objecte porten ukan (dut/duzu/du).
- id: ex-03-jn-mc3
  type: multiple-choice
  prompt: Vols dir "La Maialen ha vingut tard". Com ho dius?
  options:
  ...
  answer: 1
  explanation: '*Etorri* (venir) és intransitiu: porta *izan*. "Ella" → *da*. Sense -k en el subjecte. Resultat: *Maialen berandu etorri da*.'
- id: ex-03-jn-fb1
  type: fill-in-blank
  prompt: M'he despertat tard = Berandu esnatu ___.
  answers:
  - naiz
  explanation: '"Esnatu" (despertar-se) és intransitiu: porta izan; "jo" → *naiz*.'
- id: ex-03-jn-fb2
  type: fill-in-blank
  prompt: Han anat al cinema = Zinera joan ___.
  answers:
  - dira
  explanation: '"Joan" porta izan; "ells" → *dira*. Resultat: *haiek zinera joan dira*.'
- id: ex-03-jn-fc
  type: flashcards
  cards:
  - eu: joan naiz
  ...
  - eu: etorri naiz
    es: he vingut
  - eu: ibili naiz
    es: he caminat / he estat per aquí
  - eu: esnatu naiz
    es: m'he despertat
  - eu: jaiki naiz
    es: m'he llevat
  ...
  - eu: atera naiz
    es: he sortit
  - eu: gaixotu naiz
    es: he emmalaltit / m'he posat malalt
  - eu: egon naiz
    es: he estat
---
