...
level: b2
order: 3
title: Carta de queja (kexa-gutuna)
estimatedMinutes: 12
covers: [b2-letter-complaint, b2-letter-structure]
exercises:
  - id: ex-b2-gut3-mc1
    type: multiple-choice
    prompt: '"Kexa agertu nahi nuke" significa…'
    options: ['Quisiera mostrar una queja', 'No tengo ninguna queja', 'Estoy contento', 'Pediré disculpas']
    answer: 0
    explanation: '*Kexa agertu* = expresar / mostrar una queja. *Nahi nuke* = quisiera (condicional cortés).'
  - id: ex-b2-gut3-mc2
    type: multiple-choice
    prompt: '¿Qué tono debe tener una carta de queja formal?'
    options:
      - "Insultante y agresivo"
      - "Firme pero respetuoso, basado en hechos"
      - "Muy emocional, lleno de adjetivos"
      - "Indirecto, sin decir lo que ha pasado"
    answer: 1
    explanation: 'La carta de queja efectiva expone hechos concretos con tono firme y respetuoso. Los insultos invalidan la queja.'
  - id: ex-b2-gut3-fb1
    type: fill-in-blank
    prompt: '"Esto no se puede aceptar" — Hau ezin daiteke ___________.'
    answers: [onartu, ONARTU]
    explanation: '*Onartu* = aceptar. *Ezin daiteke onartu* es una fórmula firme habitual en cartas de queja.'
  - id: ex-b2-gut3-fc
    type: flashcards
    cards:
      - { eu: kexa, es: queja }
      - { eu: kexa agertu, es: expresar queja }
      - { eu: kexua jarri, es: poner una queja }
      - { eu: arazoa, es: el problema }
      - { eu: gertatu zen, es: ocurrió }
      - { eu: erantzukizuna, es: responsabilidad }
      - { eu: kalte-ordaina, es: indemnización }
      - { eu: konponbidea, es: solución }
      - { eu: neurriak hartu, es: tomar medidas }
      - { eu: berriz gerta ez dadin, es: para que no vuelva a ocurrir }
      - { eu: ezin daiteke onartu, es: no se puede aceptar }
      - { eu: ez dut jaso, es: no he recibido }
  - id: ex-b2-gut3-mp
    type: match-pairs
    pairs:
      - { eu: kexa agertu, es: expresar queja }
      - { eu: arazoa konpondu, es: resolver el problema }
      - { eu: kalte-ordaina eskatu, es: pedir indemnización }
      - { eu: neurriak hartu, es: tomar medidas }
      - { eu: erantzukizuna onartu, es: asumir responsabilidad }
---
...
| Nivel | Fórmula |
|---|---|
| Mínimo: explicación | *Azalpen bat eskatzen dizuet.* |
| Intermedio: solución | *Berehala konpontzeko eskatzen dizuet.* |
| Máximo: indemnización | *Kalte-ordain bat eskatzen dut, ___ euroko zenbatekoan.* |

Cierre habitual:

> *Erantzun egokia jaso ezean, dagokion erakundera joko dut.*
> — Si no recibo una respuesta adecuada, acudiré al organismo competente.
