...
id: b2-aditza-1
unitId: b2-aditza
code: 01-aditz-erregimena
unit: 03-aditza-sakontzen
level: b2
order: 1
title: Régimen verbal DA / DU
estimatedMinutes: 12
covers: [b2-aditz-erregimena, b2-indicative-review]
exercises:
  - id: ex-b2-adi1-mc1
    type: multiple-choice
    prompt: '¿Qué auxiliar necesita el verbo "gertatu" (ocurrir)?'
    options: ['NOR (DA)', 'NOR-NORK (DU)', 'NOR-NORI (ZAIO)', 'Cualquiera']
    answer: 0
    explanation: '*Gertatu* es intransitivo: *Zer gertatu da?* (¿Qué ha pasado?) — usa el auxiliar NOR/DA.'
  - id: ex-b2-adi1-mc2
    type: multiple-choice
    prompt: '"Se me ha olvidado" se construye con:'
    options: ['NOR — Ahaztu naiz', 'NOR-NORI — Ahaztu zait', 'NOR-NORK — Ahaztu dut', 'NORK — Ahaztu nuen']
    answer: 1
    explanation: '*Ahaztu* en estilo "se me ha olvidado" se construye NOR-NORI: *Ahaztu zait* (lit. "se me ha olvidado a mí").'
  - id: ex-b2-adi1-fb1
    type: fill-in-blank
    prompt: '"He traído pan" — Ogia ekarri _______.'
    answers: [dut, DUT]
    explanation: '*Ekarri* (traer) es verbo transitivo NOR-NORK: aux *dut*. Si es a alguien (NOR-NORI-NORK): *ekarri diot*.'
  - id: ex-b2-adi1-fb2
    type: fill-in-blank
    prompt: '"Le he traído pan a Olatz" — Olatzi ogia ekarri ______.'
    answers: [diot, DIOT]
    explanation: 'Hay un dativo (*Olatzi*), por tanto es NOR-NORI-NORK: *diot* (yo le ___ a él/ella).'
  - id: ex-b2-adi1-fc
    type: flashcards
    cards:
      - { eu: gertatu zait, es: me ha pasado / sucedido }
      - { eu: ahaztu zait, es: se me ha olvidado }
      - { eu: erori zait, es: se me ha caído }
      - { eu: ekarri diot, es: le he traído (a alguien) }
      - { eu: ekarri nau, es: me ha traído }
      - { eu: eraman dit, es: me ha llevado / quitado algo }
      - { eu: eraman nau, es: me ha llevado (a mí) }
      - { eu: gustatu zait, es: me ha gustado }
      - { eu: ezagutu nau, es: me ha reconocido }
      - { eu: zaindu nau, es: me ha cuidado }
  - id: ex-b2-adi1-mp
    type: match-pairs
    pairs:
      - { eu: ekarri dut, es: lo he traído }
      - { eu: ekarri nau, es: me ha traído }
      - { eu: ekarri diot, es: se lo he traído }
      - { eu: eraman dit, es: me lo ha llevado }
      - { eu: eraman nau, es: me ha llevado a mí }
---
...
> Si el "me" es **complemento directo** (a mí), es NOR-NORK.
> Si el "me" es **indirecto** (a mí, algo más viene), es NOR-NORI-NORK.
...
> *etorri (NOR) — Ni etorri naiz.*
> *ekarri (NOR-NORK) — Nik ogia ekarri dut.*
> *gertatu (NOR-NORI) — Niri gertatu zait.*
