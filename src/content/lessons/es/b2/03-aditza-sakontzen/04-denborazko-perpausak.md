...
id: b2-aditza-4
unitId: b2-aditza
code: 04-denborazko-perpausak
unit: 03-aditza-sakontzen
level: b2
order: 4
title: Subordinadas de tiempo
estimatedMinutes: 13
covers: [b2-denbora-nean, b2-denbora-tzean, b2-denbora-takoan, b2-denbora-bitartean, b2-denbora-aurretik]
exercises:
  - id: ex-b2-adi4-mc1
    type: multiple-choice
    prompt: '"Cuando llegué a casa, ya no estaba" se dice…'
    options:
      - "Etxera iristen nintzenean, ez zegoen jada"
      - "Etxera iritsi nintzenean, ez zegoen jada"
      - "Etxera iristerakoan, ez zegoen jada"
      - "Etxera iritsi ondoren, ez zegoen jada"
    answer: 1
    explanation: '*-(e)nean* sobre el auxiliar pasado: *iritsi nintzen* + *-en* + *-ean* = *iritsi nintzenean*. La acción es puntual, no habitual.'
  - id: ex-b2-adi4-mc2
    type: multiple-choice
    prompt: '"Al abrir la puerta, vi a Olatz" — la subordinada usa:'
    options:
      - "ireki nuenean"
      - "irekitzean"
      - "irekitakoan"
    ...
    answer: 3
    explanation: 'Tanto *Atea ireki nuenean* como *Atea irekitzean* funcionan: el primero más detallado, el segundo más sintético. *Irekitakoan* añade matiz de "una vez abierta".'
  - id: ex-b2-adi4-fb1
    type: fill-in-blank
  ...
  - id: ex-b2-adi4-fc
    type: flashcards
    cards:
      - { eu: -nean, es: cuando (sobre auxiliar) }
      - { eu: -tzean, es: al + infinitivo }
      - { eu: -tzerakoan, es: al + infinitivo (más matiz) }
      - { eu: -takoan, es: una vez que }
  ...
  - id: ex-b2-adi4-mp
    type: match-pairs
    pairs:
      - { eu: etortzen denean, es: cuando viene (habitual) }
      - { eu: etorri zenean, es: cuando vino (puntual pasado) }
      - { eu: etortzean, es: al venir }
      - { eu: etorritakoan, es: una vez venido }
      - { eu: etorri ondoren, es: después de venir }
---
...
|---|---|---|
| **-(e)nean** | Cuando (sobre el aux. conjugado) | *Etortzen den**ean***, deituko diot. |
