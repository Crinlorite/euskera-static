...
id: b2-aditza-3
unitId: b2-aditza
code: 03-zehar-estiloa
unit: 03-aditza-sakontzen
level: b2
order: 3
title: Estilo indirecto (zehar estiloa)
estimatedMinutes: 13
covers: [b2-zehar-estiloa-intro, b2-zehar-estiloa-tense, b2-perpaus-osagarriak]
exercises:
  - id: ex-b2-adi3-mc1
    type: multiple-choice
    prompt: 'Estilo directo: *"Bihar etorriko naiz"*. En estilo indirecto pasado:'
    options:
      - "Esan zuen bihar etorriko zela"
      - "Esan zuen hurrengo egunean etorriko zela"
      - "Esan zuen bihar etortzen dela"
      - "Esan zuen hurrengo egunean etorri zela"
    answer: 1
    explanation: 'Cuando pasamos a indirecto pasado: el adverbio temporal cambia (*bihar* → *hurrengo egunean*) y el verbo va a futuro pasado (*etorriko naiz* → *etorriko zela*).'
  - id: ex-b2-adi3-mc2
    type: multiple-choice
    prompt: 'Pregunta directa: *"Non bizi zara?"*. En estilo indirecto:'
    options:
      - "Galdetu zidan non bizi naizen"
      - "Galdetu zidan non bizi nintzen"
      - "Galdetu zidan non bizi zaren"
      - "Galdetu zidan non bizi zen"
    answer: 1
    explanation: 'Pregunta indirecta + cambio temporal: *zara* (presente, "tú") → *nintzen* (pasado, "yo", porque ahora hablo de mí mismo siendo el receptor de la pregunta).'
  - id: ex-b2-adi3-fb1
    type: fill-in-blank
    prompt: '"Le dijo que volvería al día siguiente" — Esan zion hurrengo egunean itzuliko ___________.'
    answers: [zela, ZELA]
    explanation: '*Itzuliko zen* ("volvería" — futuro pasado) + *-la* (completiva) = *itzuliko zela*.'
  - id: ex-b2-adi3-fc
    type: flashcards
    cards:
      - { eu: zehar estiloa, es: estilo indirecto }
      - { eu: estilo zuzena, es: estilo directo }
      - { eu: esan dit etorriko dela, es: me ha dicho que vendrá }
      - { eu: esan zidan etorriko zela, es: me dijo que vendría }
      - { eu: galdetu zidan non bizi nintzen, es: me preguntó dónde vivía }
      - { eu: gomendatu dit liburua irakurtzeko, es: me ha recomendado leer el libro }
      - { eu: hurrengo egunean, es: al día siguiente }
      - { eu: aurreko egunean, es: el día anterior }
      - { eu: orduan, es: entonces / en aquel momento }
      - { eu: ordura arte, es: hasta entonces }
  - id: ex-b2-adi3-mp
    type: match-pairs
    pairs:
      - { eu: orain, es: entonces (en pasado indirecto) }
      - { eu: bihar, es: al día siguiente (en pasado indirecto) }
      - { eu: atzo, es: el día anterior (en pasado indirecto) }
      - { eu: hemen, es: allí (en pasado indirecto) }
      - { eu: gaur, es: aquel día (en pasado indirecto) }
---
...
> *Esaten du etorriko **dela**.* — Dice que vendrá.
> *Galdetzen dit non bizi **naizen**.* — Me pregunta dónde vivo.
...
> Olatzek esan dit: *"**Ni** Donostian bizi naiz."*
> → Olatzek esan dit Donostian bizi **dela**.
...
> *Esan zidan: "Hartu txartela."*
> → Esan zidan txartela **hartzeko**.

> *Eskatu zion: "Mesedez, etor zaitez."*
> → Eskatu zion **etortzeko**.
