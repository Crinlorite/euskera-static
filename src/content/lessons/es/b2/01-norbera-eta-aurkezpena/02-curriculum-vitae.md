...
id: b2-norbera-2
unitId: b2-norbera
code: 02-curriculum-vitae
unit: 01-norbera-eta-aurkezpena
level: b2
order: 2
title: El currículum en euskera
estimatedMinutes: 13
covers: [b2-cv-writing, b2-self-presentation]
exercises:
  - id: ex-b2-norb2-mc1
    type: multiple-choice
    prompt: '¿Cómo se titula la sección "Experiencia laboral" en un CV en euskera?'
    options: ['Lan-esperientzia', 'Lan-eskaintza', 'Lan-poltsa', 'Lanaldia']
    answer: 0
    explanation: '*Lan-esperientzia* = experiencia laboral. *Lan-eskaintza* es "oferta de empleo".'
  - id: ex-b2-norb2-mc2
    type: multiple-choice
    prompt: '"Hizkuntzak" en un CV se refiere a…'
    options: ['Tu lenguaje corporal', 'Los idiomas que conoces', 'Tu lengua materna solamente', 'Las lenguas extranjeras únicamente']
    answer: 1
    explanation: '*Hizkuntzak* = idiomas. Se listan todos, incluyendo la materna y los niveles (A2, B1, B2…).'
  - id: ex-b2-norb2-fb1
    type: fill-in-blank
    prompt: 'Datu __________: izena, helbidea, telefonoa, emaila.'
    answers: [pertsonalak, PERTSONALAK]
    explanation: '*Datu pertsonalak* = datos personales. Es el primer apartado de cualquier CV.'
  - id: ex-b2-norb2-fb2
    type: fill-in-blank
    prompt: '"Conocimientos informáticos" = ___________ ezagutzak.'
    answers: [informatika, INFORMATIKA, Informatika]
    explanation: '*Informatika ezagutzak*. *Ezagutzak* = conocimientos.'
  - id: ex-b2-norb2-fc
    type: flashcards
    cards:
      - { eu: Curriculum Vitae / Bizitzaren laburpena, es: Currículum }
      - { eu: Datu pertsonalak, es: Datos personales }
      - { eu: Ikasketak / Prestakuntza, es: Estudios / Formación }
      - { eu: Lan-esperientzia, es: Experiencia laboral }
      - { eu: Hizkuntzak, es: Idiomas }
      - { eu: Gaitasunak, es: Capacidades }
      - { eu: Informatika ezagutzak, es: Conocimientos informáticos }
      - { eu: Erreferentziak, es: Referencias }
      - { eu: Zaletasunak, es: Aficiones }
      - { eu: Lan-poltsa, es: Bolsa de trabajo }
      - { eu: Goi-mailako titulua, es: Titulación superior }
      - { eu: Aldi baterako kontratua, es: Contrato temporal }
---
