...
level: b2
order: 3
title: Oraciones reflexivas (bihurkariak)
estimatedMinutes: 12
covers: [b2-bihurkariak]
exercises:
  - id: ex-b2-norb3-mc1
    type: multiple-choice
    prompt: '"Me he conocido a mí mismo" se dice…'
    options:
      - "Ni neuk ezagutu naiz"
      - "Neure burua ezagutu dut"
      - "Ni ezagutzen naiz"
      - "Nik ezagutu naiz"
    answer: 1
    explanation: 'La construcción reflexiva es **norbera + bere burua + verbo transitivo**: *neure burua ezagutu dut* (literalmente "he conocido mi cabeza", es decir, a mí mismo).'
  - id: ex-b2-norb3-mc2
    type: multiple-choice
  ...
  - id: ex-b2-norb3-fb1
    ...
    answers: [Zeuen, zeuen, ZEUEN]
    explanation: 'Plural reflexivo de 2ª persona = *zeuen* (o *zuen* en variante menos enfática). El objeto reflexivo es *zeuen buruak* (vuestras cabezas).'
  - id: ex-b2-norb3-fc
    type: flashcards
    cards:
      - { eu: neure burua, es: a mí mismo / a mí misma }
      - { eu: zeure burua, es: a ti mismo / misma }
      - { eu: bere burua, es: a sí mismo / misma }
      - { eu: geure buruak, es: a nosotros mismos / mismas }
      - { eu: zeuen buruak, es: a vosotros mismos / mismas }
      - { eu: beren buruak, es: a sí mismos / mismas }
      - { eu: neure burua ezagutu dut, es: me he conocido a mí mismo/a }
      - { eu: bere burua maite du, es: se quiere a sí mismo/a }
      - { eu: geure buruari galdetu diogu, es: nos hemos preguntado a nosotros mismos/as }
  - id: ex-b2-norb3-mp
    type: match-pairs
    pairs:
      - { eu: neure buruari, es: a mí mismo (dativo) }
      - { eu: zeure buruari, es: a ti mismo (dativo) }
      - { eu: bere buruaren alde, es: a favor de sí mismo }
      - { eu: bere buruaren aurka, es: contra sí mismo }
      - { eu: bere buruaz, es: de sí mismo }
---
