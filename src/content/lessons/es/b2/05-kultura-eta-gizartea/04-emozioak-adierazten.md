...
id: b2-kultura-4
unitId: b2-kultura
code: 04-emozioak-adierazten
unit: 05-kultura-eta-gizartea
level: b2
order: 4
title: Expresar emociones con matiz
estimatedMinutes: 12
covers: [b2-emotions-express, b2-emotions-classify, b2-noren-zeren]
exercises:
  - id: ex-b2-kul4-mc1
    type: multiple-choice
    prompt: '"Le tengo cariño" se dice…'
    options:
  ...
  - id: ex-b2-kul4-mc2
    ...
    options:
      - "Asko miresten ninduen"
      - "Asko mires zen niregatik"
      - "Mireste handia eman zidan"
      - "Las tres son válidas"
    answer: 0
    explanation: '*Miretsi* es transitivo NOR-NORK: *Asko miresten ninduen* = me admiraba mucho.'
  - id: ex-b2-kul4-fb1
    type: fill-in-blank
    prompt: '"Se me parte el alma" — Bihotza ___________ zait.'
    answers: [hausten, HAUSTEN]
    explanation: '*Bihotza hausten zait* = se me parte el corazón. NOR-NORI sobre *hausten zait*.'
  - id: ex-b2-kul4-fc
    type: flashcards
    cards:
      - { eu: errukia diot, es: le tengo compasión }
      - { eu: maitasuna diot, es: le tengo cariño }
      - { eu: gorrotoa diot, es: le tengo odio }
      - { eu: miresten dut, es: lo/la admiro }
      - { eu: nazka ematen dit, es: me da asco }
      - { eu: lotsa ematen dit, es: me da vergüenza }
      - { eu: bihotza hausten zait, es: se me parte el corazón }
      - { eu: hunkitu nau, es: me ha emocionado }
      - { eu: zirrara eragin dit, es: me ha conmovido }
      - { eu: bekaitza diot, es: le tengo envidia }
      - { eu: harro nago, es: estoy orgulloso/a }
      - { eu: itxaropena dut, es: tengo esperanza }
  - id: ex-b2-kul4-mp
    type: match-pairs
    pairs:
      - { eu: errukia diot, es: le tengo lástima }
      - { eu: bekaitza diot, es: le tengo envidia }
      - { eu: gorrotoa diot, es: le tengo odio }
      - { eu: miresmena diot, es: le tengo admiración }
      - { eu: maitasuna diot, es: le tengo cariño }
---
