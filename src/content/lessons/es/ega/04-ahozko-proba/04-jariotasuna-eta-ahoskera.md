...
id: ega-ahozkoa-4
unitId: ega-ahozkoa
code: 04-jariotasuna-eta-ahoskera
unit: 04-ahozko-proba
level: ega
order: 4
title: Fluidez, registro y pronunciación EGA
estimatedMinutes: 22
covers: [ega-fluency, ega-pronunciation]
exercises:
  - id: ex-eg-ah4-mc1
    type: multiple-choice
    prompt: ¿Cuál de estas muletillas es ÚTIL en una intervención EGA porque aporta tiempo sin penalizar?
    options:
      - 'esan dezagun, …'
      - 'eeeeh …'
      - 'osea …'
      - 'pues …'
    answer: 0
    explanation: '"Esan dezagun" / "demagun" funcionan como muletilla controlada en euskera. Las otras tres son interferencias del castellano o sonidos vacíos.'
  - id: ex-eg-ah4-mc2
    type: multiple-choice
    prompt: La pronunciación correcta del sonido "tx" se acerca más a…
    options:
      - '"ch" castellana (chico → tx)'
      - '"ts" inglesa'
      - '"x" francesa'
      - '"k" sorda'
    answer: 0
    explanation: '"Tx" en euskera suena como la "ch" castellana. *txakurra* = "chakurra". El "x" suena como la "sh" inglesa, y "tz" es una africada distinta.'
  - id: ex-eg-ah4-mc3
    type: multiple-choice
    prompt: ¿Cuál de estos hábitos lingüísticos del castellano interfiere y conviene corregir en la oral del EGA?
    options:
      - Usar "h" muda como en castellano (h aspirada en euskera).
      - Pronunciar la "r" simple como vibrante múltiple sistemáticamente.
      - Pronunciar todas las vocales con duración igual y abierta.
      - Reducir las vocales finales como en inglés.
    answer: 1
    explanation: 'En euskera, la "r" simple intervocálica es como en castellano (suave: *gara*). Pronunciar siempre RR fuerte donde toca R simple es interferencia de algunos hablantes.'
  - id: ex-eg-ah4-mc4
    type: multiple-choice
    prompt: 'Cuando aparece "ai", "ei", "oi" en euskera, son…'
    options:
      - Diptongos descendentes que se pronuncian en una sola sílaba.
      - Hiatos siempre.
      - Vocales independientes con ataque glotal.
      - Indistintos según el dialecto.
    answer: 0
    explanation: 'Los diptongos *ai, ei, oi, au, eu* se pronuncian en una sola sílaba en batua (*aita, gehiago, oilo, gau, euri*).'
  - id: ex-eg-ah4-fc
    type: flashcards
    cards:
      - { eu: jariotasuna, es: fluidez }
      - { eu: ahoskera, es: pronunciación }
      - { eu: erregistroa, es: registro }
      - { eu: doinua, es: entonación / tono }
      - { eu: erritmoa, es: ritmo }
      - { eu: hitz egiteko abiadura, es: velocidad al hablar }
      ...
      - { eu: ahozko jarduera, es: actividad oral }
      - { eu: hizketaldia, es: charla / conversación }
---
