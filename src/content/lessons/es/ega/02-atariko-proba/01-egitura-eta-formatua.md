...
id: ega-atariko-1
unitId: ega-atariko
code: 01-egitura-eta-formatua
unit: 02-atariko-proba
level: ega
order: 1
title: Atariko proba — estructura, formato y reparto de puntos
estimatedMinutes: 22
covers: [ega-atariko-structure]
exercises:
  - id: ex-eg-at1-mc1
    type: multiple-choice
    prompt: ¿Cuántos ítems tiene en total la atariko proba?
    options: ['60', '70', '80', '100']
    answer: 2
    explanation: 'La atariko proba consta de 80 ítems que valen 80 puntos en total.'
  - id: ex-eg-at1-mc2
    type: multiple-choice
    prompt: De los 80 puntos totales, ¿cuántos corresponden a Hizkuntza baliabideak?
    options: ['30', '40', '50', '60']
    answer: 2
    explanation: 'Hizkuntza baliabideak es la mayor parte: 50 puntos (40 multiple-choice + 10 cloze). Las otras dos secciones suman 15 puntos cada una.'
  - id: ex-eg-at1-mc3
    type: multiple-choice
    prompt: Las preguntas tipo cloze de la atariko ofrecen…
    options:
      ...
      - Respuesta abierta.
    answer: 1
    explanation: 'El cloze test usa tres opciones (a-b-c) frente a las cuatro (a-b-c-d) del multiple-choice general.'
  - id: ex-eg-at1-mc4
    type: multiple-choice
    prompt: ¿Cuánto tiempo se da en total para la atariko proba?
    options: ['1,5 horas', '2 horas', '2,5 horas', '3 horas']
    answer: 2
    explanation: '2,5 horas para los 80 ítems. Dividido a partes iguales serían menos de 2 minutos por ítem, pero los de comprensión lectora son más lentos y los de gramática más rápidos.'
  - id: ex-eg-at1-mp
    type: match-pairs
    pairs:
      - { eu: 40 itemeko aukera anitzeko testa, es: 40 ítems multiple-choice (a-b-c-d) }
      - { eu: 10 itemeko cloze testa, es: 10 ítems cloze (a-b-c) }
      - { eu: 10 itemeko entzunaren testa, es: 10 ítems de comprensión auditiva }
      - { eu: 5 itemeko entzunaren lotura, es: 5 ítems de emparejar audio breve }
      - { eu: 10 itemeko irakurriaren testa, es: 10 ítems de comprensión lectora }
      - { eu: 5 itemeko irakurriaren lotura, es: 5 ítems de emparejar texto breve }
---
...
| Sección | Tipo | Ítems | Puntos |
|---|---|---|---|
| Hizkuntza baliabideak | Test a-b-c-d | 40 | 40 |
| Hizkuntza baliabideak | Cloze a-b-c | 10 | 10 |
| Entzunaren ulermena | Test a-b-c sobre audios | 10 | 10 |
| Entzunaren ulermena | Audios breves + adierazpenak | 5 | 5 |
| Irakurriaren ulermena | Test a-b-c sobre lecturas | 10 | 10 |
| Irakurriaren ulermena | Textos breves + adierazpenak | 5 | 5 |
| **Total** | | **80** | **80** |
