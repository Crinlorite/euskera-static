...
id: a2-iragana-2
unitId: a2-iragana
code: 02-iragan-burutua-ukan
unit: 02-iragana
level: a2
order: 2
title: Iragan burutua NOR-NORK — ukan en pasado
estimatedMinutes: 13
covers: [a2-past-nor-nork, a2-past-trinkoak]
exercises:
  - id: ex-a2-ir2-mc1
    type: multiple-choice
    prompt: '"Liburua irakurri nuen" significa…'
    options: ['Estoy leyendo el libro', 'He leído el libro', 'Leí el libro', 'Voy a leer el libro']
    answer: 2
    explanation: '*Nuen* es el pasado de *dut* (yo lo). *Irakurri nuen* = "leí" (pasado completo).'
  - id: ex-a2-ir2-mc2
    type: multiple-choice
    prompt: '¿Qué forma de "ukan" en pasado corresponde a "ellos lo"?'
    options: [zuten, zituen, zenuten, dute]
    answer: 0
    explanation: '*Zuten* = "ellos lo" (sing.), pasado. *Zituzten* sería plural.'
  - id: ex-a2-ir2-fb1
    type: fill-in-blank
    prompt: 'Compré las entradas = Sarrerak erosi ___ .'
    answers: [nituen]
    explanation: 'Como el objeto es plural (sarrerak), el auxiliar va en plural: *nituen*.'
  - id: ex-a2-ir2-fb2
    type: fill-in-blank
    prompt: 'Lander tenía un coche rojo = Landerrek auto gorri bat ___ .'
    answers: [zeukan]
    explanation: '*Eduki* en pasado sintético, 3ª persona singular = *zeukan*.'
  - id: ex-a2-ir2-fc
    type: flashcards
    cards:
      ...
      - { eu: nituen, es: 'yo los (pasado, objeto pl.)' }
      - { eu: zenituen, es: 'tú los (pasado)' }
      - { eu: zituen, es: 'él/ella los (pasado)' }
      - { eu: genituen, es: 'nosotros los (pasado)' }
      - { eu: zituzten, es: 'ellos los (pasado)' }
      - { eu: neukan, es: 'yo tenía (sintético, eduki)' }
      - { eu: zeukan, es: 'él/ella tenía' }
      - { eu: nekien, es: 'yo sabía (jakin)' }
      - { eu: zekien, es: 'él/ella sabía' }
  - id: ex-a2-ir2-mp
    type: match-pairs
    pairs:
      - { eu: 'Liburua irakurri nuen', es: 'Leí el libro' }
      - { eu: 'Filma ikusi genuen', es: 'Vimos la película' }
      - { eu: 'Sarrerak erosi nituen', es: 'Compré las entradas' }
      - { eu: 'Egia jakin zuten', es: 'Supieron la verdad' }
      - { eu: 'Nik bizikleta neukan', es: 'Yo tenía bici' }
      - { eu: 'Zer esan zenuen?', es: '¿Qué dijiste?' }
---
...
> *Garazi**k** afaria egin **zuen**.* — Garazi hizo la cena.
>
> *Lander**rek** sarrerak erosi **zituen**.* — Lander compró las entradas.
