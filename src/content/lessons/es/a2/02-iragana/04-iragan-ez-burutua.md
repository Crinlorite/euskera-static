...
id: a2-iragana-4
unitId: a2-iragana
code: 04-iragan-ez-burutua
unit: 02-iragana
level: a2
order: 4
title: Iragan ez burutua — pasado imperfecto y aspecto progresivo
estimatedMinutes: 14
covers: [a2-past-imperfect, a2-perfect-vs-imperfect, a2-past-progressive]
exercises:
  - id: ex-a2-ir4-mc1
  ...
  - id: ex-a2-ir4-fb1
    type: fill-in-blank
    prompt: 'De pequeño jugaba al fútbol = Txikitan futbolean ___ nuen.'
    answers: [jokatzen]
    explanation: 'Para hábito en pasado: verbo en *-tzen* + auxiliar pasado.'
  - id: ex-a2-ir4-fb2
    type: fill-in-blank
    prompt: 'Estaba comiendo cuando llegó = Jaten ari ___ etorri zenean.'
    answers: [nintzen]
    explanation: '*Ari + nintzen* = "estaba (haciendo)". Aspecto progresivo en pasado.'
  - id: ex-a2-ir4-fc
    type: flashcards
    cards:
      - { eu: lan egiten nuen, es: 'trabajaba (yo)' }
      - { eu: ikusten zuen, es: 'veía (él/ella)' }
      - { eu: jaten genuen, es: 'comíamos' }
      - { eu: bizi nintzen, es: 'vivía (yo)' }
      - { eu: joaten ginen, es: 'íbamos (habitualmente)' }
      - { eu: irakasle nintzen, es: 'era profesor' }
      - { eu: 'jaten ari nintzen', es: 'estaba comiendo' }
      - { eu: 'lanean ari ginen', es: 'estábamos trabajando' }
      - { eu: txikitan, es: 'de pequeño' }
      - { eu: garai hartan, es: 'en aquella época' }
      - { eu: lehen, es: 'antes' }
  - id: ex-a2-ir4-mp
    type: match-pairs
    pairs:
      - { eu: 'Joan nintzen', es: 'Fui (puntual)' }
      - { eu: 'Joaten nintzen', es: 'Iba (hábito)' }
      - { eu: 'Joan nuen autoa', es: '(no es válido)' }
      - { eu: 'Joaten ari nintzen', es: 'Estaba yendo' }
      - { eu: 'Bizi nintzen Bilbon', es: 'Vivía en Bilbao' }
      - { eu: 'Bilbora joan nintzen atzo', es: 'Fui a Bilbao ayer' }
---
