...
id: a2-iragana-1
unitId: a2-iragana
code: 01-iragan-burutua-nor
unit: 02-iragana
level: a2
order: 1
title: Iragan burutua NOR — pasado de izan y egon
estimatedMinutes: 13
covers: [a2-past-nor, a2-past-time-markers]
exercises:
  - id: ex-a2-ir1-mc1
  ...
  - id: ex-a2-ir1-fb1
    type: fill-in-blank
    prompt: 'Hace dos años éramos vecinos = Duela bi urte bizilagunak ___ .'
    answers: [ginen]
    explanation: 'Pasado de "izan" para "gu" (nosotros) = *ginen*.'
  - id: ex-a2-ir1-fb2
    type: fill-in-blank
    prompt: 'Anoche estuvimos en el cine = Bart zinean egon ___ .'
    answers: [ginen]
    explanation: '*Egon ginen* = estuvimos.'
  - id: ex-a2-ir1-fc
    type: flashcards
    cards:
      - { eu: nintzen, es: 'yo era/estaba/fui/estuve' }
      - { eu: zinen, es: 'tú eras/estabas' }
      - { eu: zen, es: 'él/ella era/estaba' }
      - { eu: ginen, es: 'éramos/estábamos' }
      - { eu: zineten, es: 'erais/estabais' }
      - { eu: ziren, es: 'eran/estaban' }
      - { eu: nengoen, es: 'yo estaba (sintético, egon)' }
      - { eu: zegoen, es: 'él/ella estaba (sintético)' }
      - { eu: zeuden, es: 'estaban (sintético)' }
      - { eu: atzo, es: 'ayer' }
      - { eu: bart, es: 'anoche' }
      - { eu: joan den astean, es: 'la semana pasada' }
      - { eu: duela bi urte, es: 'hace dos años' }
...
> Truco: la **n** final aparece en todas las formas (n**intzen**, zi**nen**, ze**n**, gi**nen**, zi**ne**ten, zir**en**). Es la marca clásica del pasado en euskera.
