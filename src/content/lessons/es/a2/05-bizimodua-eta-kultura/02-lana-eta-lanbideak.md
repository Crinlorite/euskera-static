...
id: a2-bizimodua-2
unitId: a2-bizimodua
code: 02-lana-eta-lanbideak
unit: 05-bizimodua-eta-kultura
level: a2
order: 2
title: Lana eta lanbideak — trabajo y entrevista laboral
estimatedMinutes: 13
covers: [a2-jobs-extended, a2-relative-en]
exercises:
  - id: ex-a2-bz2-mc1
    type: multiple-choice
    prompt: '"Lan-elkarrizketa" significa…'
    options: ['Conferencia', 'Entrevista de trabajo', 'Llamada de teléfono', 'Cita médica']
    answer: 1
    explanation: '*Elkarrizketa* = entrevista. *Lan-elkarrizketa* = entrevista de trabajo.'
  - id: ex-a2-bz2-mc2
    type: multiple-choice
    prompt: '"Soldata" significa…'
    options: [Trabajo, Sueldo, Jefe, Empleado]
    answer: 1
    explanation: '*Soldata* = sueldo. *Lansari* es sinónimo formal.'
  - id: ex-a2-bz2-fb1
    type: fill-in-blank
    prompt: 'Trabajo a media jornada = ___ erdiko lana daukat.'
    answers: [Lanaldi]
    explanation: '*Lanaldia* = jornada laboral. *Lanaldi erdiko lana* = trabajo a media jornada.'
  - id: ex-a2-bz2-fc
    type: flashcards
    cards:
      - { eu: 'lana', es: 'el trabajo' }
      - { eu: 'lanbidea', es: 'el oficio / profesión' }
      - { eu: 'soldata / lansaria', es: 'sueldo' }
      - { eu: 'lanaldia', es: 'jornada laboral' }
      - { eu: 'lanaldi osokoa', es: 'jornada completa' }
      - { eu: 'lanaldi erdikoa', es: 'media jornada' }
      - { eu: 'lankidea', es: 'compañero/a de trabajo' }
      - { eu: 'nagusia', es: 'el jefe / la jefa' }
      - { eu: 'langilea', es: 'trabajador/a' }
      - { eu: 'enpresa', es: 'empresa' }
      - { eu: 'kontratua', es: 'contrato' }
      - { eu: 'oporrak', es: 'vacaciones' }
      - { eu: 'lan-elkarrizketa', es: 'entrevista de trabajo' }
      - { eu: 'curriculuma', es: 'CV' }
      - { eu: 'esperientzia', es: 'experiencia' }
      - { eu: 'lanpostua', es: 'puesto de trabajo' }
      - { eu: 'lanbide elkargoa', es: 'colegio profesional' }
  - id: ex-a2-bz2-mp
    type: match-pairs
    pairs:
      - { eu: 'irakasle', es: 'profesor/a' }
      - { eu: 'erizain', es: 'enfermero/a' }
      - { eu: 'sukaldari', es: 'cocinero/a' }
      - { eu: 'kazetari', es: 'periodista' }
      - { eu: 'mekanikari', es: 'mecánico/a' }
      - { eu: 'arkitekto', es: 'arquitecto/a' }
---
