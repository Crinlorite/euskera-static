...
id: a2-bizimodua-3
unitId: a2-bizimodua
code: 03-jaiak-eta-tradizioak
unit: 05-bizimodua-eta-kultura
level: a2
order: 3
title: Jaiak eta tradizioak — fiestas y comparaciones culturales
estimatedMinutes: 13
covers: [a2-festivals, a2-routines-compare, a2-distributive]
exercises:
  - id: ex-a2-bz3-mc1
    type: multiple-choice
    prompt: '"San Juan sua" da…'
    options: ['La fiesta del trabajo', 'La hoguera de San Juan', 'La cena de San Juan', 'El mercado de San Juan']
    answer: 1
    explanation: '*Sua* = el fuego, la hoguera. *San Juan sua* es la hoguera tradicional del 23 de junio.'
  - id: ex-a2-bz3-mc2
    type: multiple-choice
    prompt: '"Lehen baserrian bizi ginen, orain hirian bizi gara" significa…'
    options:
      - 'Antes vivíamos en el caserío, ahora vivimos en la ciudad'
      - 'Vivimos en el caserío y la ciudad'
      - 'Iremos del caserío a la ciudad'
  ...
  - id: ex-a2-bz3-fc
    type: flashcards
    cards:
      - { eu: 'jaia', es: 'la fiesta' }
      - { eu: 'ospakizuna', es: 'la celebración' }
      - { eu: 'tradizioa', es: 'la tradición' }
      - { eu: 'ohitura', es: 'la costumbre' }
      - { eu: 'sua', es: 'el fuego / hoguera' }
      - { eu: 'sukaldaritza', es: 'la gastronomía' }
      - { eu: 'dantza', es: 'la danza' }
      - { eu: 'kantua', es: 'la canción' }
      - { eu: 'bertsolaria', es: 'el bertsolari' }
      - { eu: 'San Juan sua', es: 'la hoguera de San Juan' }
      - { eu: 'Olentzero', es: 'Olentzero (carbonero navideño)' }
      - { eu: 'Korrika', es: 'Korrika (carrera por el euskera)' }
      - { eu: 'aratusteak / inauteriak', es: 'carnavales' }
      - { eu: 'lehen', es: 'antes' }
      - { eu: 'orain', es: 'ahora' }
      - { eu: 'aldatu', es: 'cambiar' }
  - id: ex-a2-bz3-mp
    type: match-pairs
    pairs:
      - { eu: 'San Juan', es: '23 de junio: hogueras' }
      - { eu: 'Olentzero', es: '24 de diciembre: carbonero' }
      - { eu: 'Korrika', es: 'carrera por el euskera' }
      - { eu: 'Aste Nagusia', es: 'Semana Grande de Bilbao' }
      - { eu: 'Aratusteak', es: 'carnavales' }
      - { eu: 'Santa Ageda', es: 'cánticos por las casas' }
---
