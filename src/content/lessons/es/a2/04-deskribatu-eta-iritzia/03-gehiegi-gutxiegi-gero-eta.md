...
code: 03-gehiegi-gutxiegi-gero-eta
unit: 04-deskribatu-eta-iritzia
level: a2
order: 3
title: Gehiegi, gutxiegi, gero eta — exceso, defecto y progresivo
estimatedMinutes: 12
covers: [a2-comp-excess, a2-comp-progressive]
exercises:
  - id: ex-a2-de3-mc1
    type: multiple-choice
    prompt: '"Gehiegi jan dut" significa…'
    options: ['He comido mucho', 'He comido poco', 'He comido demasiado', 'No he comido']
    answer: 2
    explanation: '*Gehiegi* = "demasiado" (cantidad excesiva). Distinto de *asko* (mucho).'
  - id: ex-a2-de3-mc2
    type: multiple-choice
    prompt: '"Gero eta hotzago" significa…'
    options: ['Bastante frío', 'Tan frío como ayer', 'Cada vez más frío', 'Demasiado frío']
    answer: 2
    explanation: '*Gero eta + adjetivo-ago* = "cada vez más X". Es la fórmula del comparativo progresivo.'
  - id: ex-a2-de3-fb1
    type: fill-in-blank
    prompt: 'Esta camisa es demasiado grande = Alkandora hau ___ da.'
    answers: [handiegia]
    explanation: 'Sufijo -egi sobre adjetivo + -a final: *handi → handiegia* = demasiado grande.'
  - id: ex-a2-de3-fc
    type: flashcards
    cards:
      - { eu: 'gehiegi', es: 'demasiado' }
      - { eu: 'gutxiegi', es: 'muy poco / insuficiente' }
      - { eu: 'handiegia', es: 'demasiado grande' }
      - { eu: 'txikiegia', es: 'demasiado pequeño' }
      - { eu: 'garestiegia', es: 'demasiado caro' }
      - { eu: 'beroegia', es: 'demasiado caliente' }
      - { eu: 'goizegi', es: 'demasiado pronto' }
      - { eu: 'beranduegi', es: 'demasiado tarde' }
      - { eu: 'gero eta hobea', es: 'cada vez mejor' }
      - { eu: 'gero eta okerragoa', es: 'cada vez peor' }
      - { eu: 'gero eta gehiago', es: 'cada vez más' }
      - { eu: 'gero eta gutxiago', es: 'cada vez menos' }
      - { eu: 'pixka bat', es: 'un poco' }
      - { eu: 'askoz', es: 'mucho (intensifica)' }
  - id: ex-a2-de3-mp
    type: match-pairs
    pairs:
      - { eu: 'gehiegi jan', es: 'comer demasiado' }
      - { eu: 'gutxiegi lo egin', es: 'dormir poco / insuficiente' }
      - { eu: 'gero eta hotzago', es: 'cada vez más frío' }
      - { eu: 'gero eta gutxiago', es: 'cada vez menos' }
      - { eu: 'pixka bat berandu', es: 'un poco tarde' }
      - { eu: 'askoz hobeto', es: 'mucho mejor' }
---
...
| Adjetivo | Excesivo |
|---|---|
| *handia* (grande) | *handi**egia*** (demasiado grande) |
| *txikia* (pequeño) | *txiki**egia*** |
| *garestia* (caro) | *garesti**egia*** |
| *beroa* (caliente) | *bero**egia*** |
| *hotza* (frío) | *hotz**egia*** |
| *zaila* (difícil) | *zail**egia*** |
| *azkarra* (rápido) | *azkarr**egia*** |
