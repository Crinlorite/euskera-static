...
id: a2-aditzak-4
unitId: a2-aditzak
code: 04-ahalera-ezin
unit: 03-aditzak-sakontzen
level: a2
order: 4
title: Ahalera y ezin — poder y no poder
estimatedMinutes: 13
covers: [a2-ahalera, a2-ezin]
exercises:
  - id: ex-a2-ad4-mc1
    type: multiple-choice
    prompt: '"Etor zaitezke?" significa…'
    options: ['¿Vienes?', '¿Puedes venir?', '¿Has venido?', '¿Vendrás?']
    answer: 1
    explanation: '*Zaitezke* es la forma de *zaitez* en ahalera = "puedes (intransitivo)". *Etor zaitezke* = ¿puedes venir?'
  - id: ex-a2-ad4-mc2
    type: multiple-choice
    prompt: '"Ezin dut joan" da…'
    options: ['No voy', 'No puedo ir', 'No iré', 'No he ido']
    answer: 1
    explanation: '*Ezin* + verbo + auxiliar = no poder. *Ezin dut joan* = no puedo ir.'
  - id: ex-a2-ad4-fb1
    type: fill-in-blank
    prompt: 'Puedo hacer esto = Hau egin ___ .'
    answers: [dezaket]
    explanation: '*Dezaket* = "yo lo puedo (NOR-NORK ahalera)".'
  - id: ex-a2-ad4-fc
    type: flashcards
    cards:
      - { eu: 'dezaket', es: 'puedo (lo) [NOR-NORK]' }
      - { eu: 'dezakezu', es: 'puedes (lo)' }
      - { eu: 'dezake', es: 'puede (lo)' }
      - { eu: 'dezakegu', es: 'podemos (lo)' }
      - { eu: 'dezakete', es: 'pueden (lo)' }
      - { eu: 'naiteke', es: 'puedo (NOR; ir, venir, estar)' }
      - { eu: 'zaitezke', es: 'puedes (NOR)' }
      - { eu: 'daiteke', es: 'puede (NOR)' }
      - { eu: 'gaitezke', es: 'podemos (NOR)' }
      - { eu: 'daitezke', es: 'pueden (NOR)' }
      - { eu: 'ezin dut', es: 'no puedo (NOR-NORK)' }
      - { eu: 'ezin naiz', es: 'no puedo (NOR)' }
      - { eu: 'ahal duzu?', es: '¿puedes? (variante coloquial)' }
  - id: ex-a2-ad4-mp
    type: match-pairs
    pairs:
      - { eu: 'Etor zaitezke', es: '¿Puedes venir?' }
      - { eu: 'Egin dezakezu', es: 'Puedes hacerlo' }
      - { eu: 'Ezin dut etorri', es: 'No puedo venir' }
      - { eu: 'Ezin nintzen joan', es: 'No podía ir' }
      - { eu: 'Ahal duzu lagundu?', es: '¿Puedes ayudar?' }
      - { eu: 'Ezin daiteke jakin', es: 'No se puede saber' }
---
