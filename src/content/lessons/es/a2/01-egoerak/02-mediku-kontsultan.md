...
id: a2-egoerak-2
unitId: a2-egoerak
code: 02-mediku-kontsultan
unit: 01-egoerak
level: a2
order: 2
title: Mediku-kontsultan — diálogo en la consulta
estimatedMinutes: 12
covers: [a2-doctor-visit, a2-health-vocab]
exercises:
  - id: ex-a2-eg2-mc1
  ...
  - id: ex-a2-eg2-mc2
    type: multiple-choice
    prompt: '"Hobeto nago" quiere decir…'
    options: [Estoy peor, Estoy bien, Estoy mejor, Estoy igual]
    answer: 2
    explanation: '*Hobeto* = mejor. *Hobe* es el adjetivo "mejor" y *hobeto* el adverbio.'
  - id: ex-a2-eg2-fb1
    type: fill-in-blank
    prompt: 'Quiero pedir cita = Hitzordua eskatu nahi ___.'
    answers: [dut]
    explanation: '*Nahi izan* es transitivo: lleva *dut*. *Hitzordua eskatu nahi dut* — quiero pedir cita.'
  - id: ex-a2-eg2-fc
    type: flashcards
    cards:
      - { eu: hitzordua eskatu, es: pedir cita }
      - { eu: hartu, es: tomar / coger }
      - { eu: orduro, es: cada hora }
      - { eu: zortzi orduro, es: cada ocho horas }
      - { eu: egunero, es: cada día }
      - { eu: jan baino lehen, es: antes de comer }
      - { eu: jan ondoren, es: después de comer }
      - { eu: hobeto, es: mejor (adv.) }
      - { eu: okerrago, es: peor (adv.) }
      - { eu: berdin, es: igual }
      - { eu: errezeta, es: receta }
      - { eu: baja, es: la baja }
      - { eu: kontsulta, es: la consulta }
  - id: ex-a2-eg2-mp
    type: match-pairs
    pairs:
      - { eu: 'Zer duzu?', es: '¿Qué te pasa?' }
      - { eu: 'Noiztik?', es: '¿Desde cuándo?' }
      - { eu: 'Min ematen dizu?', es: '¿Te duele?' }
      - { eu: 'Hartu hau', es: 'Toma esto' }
      - { eu: 'Itzuli astebete barru', es: 'Vuelve dentro de una semana' }
      - { eu: 'Atseden hartu', es: 'Descansar' }
---
