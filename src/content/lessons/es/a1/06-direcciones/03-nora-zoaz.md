...
level: a1
order: 3
title: ¿Adónde vas? — el caso NORA
estimatedMinutes: 12
covers: [nora-allative, movement-verbs, places-town]
exercises:
  - id: ex-nz-mc1
    type: multiple-choice
    prompt: '¿Cómo se dice "Voy a Bilbao"?'
    options: ["Bilbon noa", "Bilbora noa", "Bilbotik noa", "Bilboan noa"]
    answer: 1
    explanation: '"Bilbo" + sufijo -ra (caso NORA) = "Bilbora", "a Bilbao".'
  - id: ex-nz-fb1
    type: fill-in-blank
    prompt: 'Voy a casa = Etxe___ noa.'
    answers: [ra]
    explanation: '"Etxe" + ra = "etxera" (a casa). El sufijo -ra es el caso NORA.'
  - id: ex-nz-fb2
    type: fill-in-blank
    prompt: 'Voy a Madrid = Madril___ noa.'
    answers: [era]
    explanation: 'Tras consonante, el sufijo intercala -e-: "Madril" → "Madrilera".'
  - id: ex-nz-mc2
    type: multiple-choice
    prompt: '¿Qué significa "Eskolara doa"?'
    options: ["Está en la escuela", "Va a la escuela", "Viene de la escuela", "Es de la escuela"]
    answer: 1
    explanation: '"Eskola" + ra (caso NORA) = "eskolara" (a la escuela); "doa" = "va".'
  - id: ex-nz-fb3
    type: fill-in-blank
  ...
  - id: ex-nz-mc3
    type: multiple-choice
    prompt: '¿Qué quiere decir "Zertara zoaz tabernara?"'
    options: ["¿Quién va al bar?", "¿De qué bar vienes?", "¿A qué vas al bar?", "¿Dónde está el bar?"]
    answer: 2
    explanation: '"Zertara" = a qué (a hacer qué); típicamente se responde con verbo + -tzera: "kafe bat hartzera" (a tomar un café).'
  - id: ex-nz-fc
    type: flashcards
    cards:
      - { eu: 'Nora?', es: ¿Adónde? }
      - { eu: 'Nora zoaz?', es: ¿Adónde vas? }
      - { eu: 'Nora doa?', es: ¿Adónde va? }
      - { eu: etxera, es: a casa }
      - { eu: eskolara, es: a la escuela }
      - { eu: euskaltegira, es: al euskaltegi }
      - { eu: tabernara, es: al bar }
      - { eu: lanera, es: al trabajo }
      - { eu: hondartzara, es: a la playa }
      - { eu: mendira, es: al monte }
      - { eu: Bilbora, es: a Bilbao }
      - { eu: Iruñera, es: a Pamplona }
      - { eu: Madrilera, es: a Madrid }
      - { eu: 'Zertara?', es: ¿A qué? }
      - { eu: erostera, es: a comprar }
  ...
  - id: ex-nz-mp
    ...
    pairs:
      ...
      - { eu: Eskolara noa, es: 'Voy a la escuela' }
