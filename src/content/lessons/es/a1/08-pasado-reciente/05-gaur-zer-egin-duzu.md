...
level: a1
order: 5
title: Cuenta tu día de hoy (lección integradora)
estimatedMinutes: 12
covers: [recent-past-dut, recent-past-naiz, recent-past-time-markers, parts-of-day, common-verbs]
exercises:
  - id: ex-05-gze-mc1
    type: multiple-choice
    prompt: '¿Cuál es la traducción correcta de "Esta mañana me he despertado tarde"?'
    options:
    ...
    answer: 1
    explanation: '"Esnatu" es intransitivo (lleva izan); "yo" → naiz. "Esta mañana" → gaur goizean.'
  - id: ex-05-gze-mc2
    type: multiple-choice
    prompt: 'En la frase "Mikelek egunkaria irakurri du", ¿por qué "Mikelek" lleva -k?'
    options:
  ...
  - id: ex-05-gze-fc
    type: flashcards
    cards:
      - { eu: 'Gaur zer egin duzu?', es: '¿Qué has hecho hoy?' }
      - { eu: Gaur goizean lanera joan naiz, es: Esta mañana he ido al trabajo }
      - { eu: Etxean gosaldu dut, es: He desayunado en casa }
      - { eu: Eguerdian lagunekin bazkaldu dut, es: A mediodía he comido con amigos }
      - { eu: Arratsaldean kafea hartu dut, es: Por la tarde he tomado café }
      - { eu: Buelta bat eman dut, es: He dado una vuelta }
      - { eu: Erosketak egin ditut, es: He hecho la compra }
      - { eu: Etxera bueltatu naiz, es: He vuelto a casa }
      - { eu: Telebista ikusi dut, es: He visto la tele }
      - { eu: Hamaiketan oheratu naiz, es: Me he acostado a las once }
      - { eu: Lasai egon naiz, es: He estado tranquilo/a }
      - { eu: Asko ikasi dut, es: He aprendido mucho }
---

Esta lección reúne todo el material de la unidad: pasado reciente con los dos auxiliares, marcadores temporales, partes del día y verbos cotidianos. El objetivo es que puedas contar tu día completo.

## El esquema mental

Para contar el día, sigue este recorrido:

1. **Cuándo te has despertado** → *Gaur ___etan esnatu naiz.*
2. **Qué has hecho por la mañana** → *Goizean ...*
3. **Cómo has ido a algún sitio** → *Lanera / euskaltegira oinez / autoz / autobusez joan naiz.*
4. **Qué has comido / bebido** → *Bazkaltzeko ___ jan dut. ___ edan dut.*
5. **Qué has hecho por la tarde** → *Arratsaldean ...*
6. **Cuándo y cómo te has acostado** → *Gauean ___etan oheratu naiz.*

## Modelo: el día de Maialen
...
>
> *Por la tarde he hecho la compra: he comprado pan, fruta y leche. Después he tomado café con un amigo en el bar.*
>
> *He cenado en casa, he visto un poco la tele y me he acostado a las once.*

## Tu turno

Sigue la misma plantilla pero con tu información real. Revisa estas dos cosas mientras escribes:

1. **¿El verbo es transitivo o intransitivo?** Si tiene objeto → *dut/duzu/du…* (con sujeto -k). Si no → *naiz/zara/da…*
2. **¿La acción es habitual o pasada reciente?** Habitual = *-tzen/-ten + auxiliar*. Pasado reciente = partizipio sin sufijo + auxiliar.
...
Esto es clave: los dos sistemas conviven y a menudo se mezclan en una misma conversación.

> *Egunero zazpietan esnatzen naiz, baina gaur zazpi eta erdietan esnatu naiz.* — Cada día me despierto a las siete, pero hoy me he despertado a las siete y media.
>
> *Normalean kafea hartzen dut, baina gaur tea hartu dut.* — Normalmente tomo café, pero hoy he tomado té.
