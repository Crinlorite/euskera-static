---
code: 05-pintxoa-eta-ogitartekoa
unit: 04-kafe-goxoa
level: a1
order: 5
...
exercises:
  - id: ex-pin-mc1
    ...
    options: [pintxo, bocadillo, plato combinado, postre]
    answer: 1
    explanation: '*ogitartekoa* viene de *ogi* (pan) + *arte* (entre): "lo de entre dos panes" — el bocadillo.'
  - id: ex-pin-mc2
    type: multiple-choice
    prompt: 'Quieres un pincho de tortilla. ¿Cómo lo pides?'
    options: [Tortillaren pintxoa, Tortilla pintxoa bat, Tortilla pintxo bat, Pintxoa tortilla]
    answer: 2
    explanation: '"Pintxo bat" pierde la `-a` al ir con *bat*; el descriptor (*tortilla*) va delante.'
  - id: ex-pin-fb1
    type: fill-in-blank
    prompt: '"Plato combinado" en euskera = ___ ___.'
    answers: [plater konbinatua, plater konbinatu]
    explanation: '*plater konbinatua* — exactamente como en castellano, sin gran adaptación.'
  - id: ex-pin-fb2
    type: fill-in-blank
    prompt: 'Para mí, una ración de queso = Niretzat ___ ___.'
    answers: [gazta razioa, gazta razio bat]
    explanation: '*razioa* = ración; con *bat* pierde la `-a`. La forma "gazta razioa" (la ración de queso) es válida.'
  - id: ex-pin-fc
    type: flashcards
    cards:
      - { eu: pintxoa, es: pincho (tapa pequeña) }
      - { eu: ogitartekoa, es: bocadillo }
      - { eu: plater konbinatua, es: plato combinado }
      - { eu: razioa, es: ración }
      ...
      - { eu: gazta ogitartekoa, es: bocadillo de queso }
