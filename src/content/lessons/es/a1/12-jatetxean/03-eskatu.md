...
level: a1
order: 3
title: Pedir la comida (eskatu)
estimatedMinutes: 10
covers: [ordering-food, food-bar]
exercises:
  - id: ex-esk-mc1
    type: multiple-choice
    prompt: '"De primero, voy a tomar ensalada" se dice…'
    options: ['Hasteko, entsalada hartuko dut', 'Lehen entsalada da', 'Entsalada bat hartzen', 'Hasteko, entsaladarik']
    answer: 0
    explanation: '*Hasteko* (para empezar) + *entsalada hartuko dut* (tomaré ensalada). Estructura típica.'
  - id: ex-esk-mc2
    type: multiple-choice
    prompt: '"Para mí, el pescado" se dice…'
