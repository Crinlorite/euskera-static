...
exercises:
  ...
  - id: ex-kont-fb2
    ...
    answers: [daukat]
    explanation: '*Daukat* — "tengo" (de *eduki*). Con negación + objeto indefinido → *kanbio**rik***.'
  - id: ex-kont-fc
    type: flashcards
    cards:
      ...
      - { eu: 'Zenbat da dena?', es: '¿Cuánto es todo?' }
      - { eu: 'Txartelaz ordain dezaket?', es: '¿Puedo pagar con tarjeta?' }
      - { eu: dirua, es: dinero }
      - { eu: txartela, es: tarjeta }
      - { eu: kanbioa, es: cambio (vuelta) }
      - { eu: 'Ez daukat kanbiorik', es: No tengo cambio }
      - { eu: 'Tori!', es: '¡Toma!' }
      - { eu: 'Eskerrik asko, oso ondo zegoen', es: 'Muchas gracias, estaba muy bueno' }
---
