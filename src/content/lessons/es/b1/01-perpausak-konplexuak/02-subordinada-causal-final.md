...
id: b1-perpausak-2
unitId: b1-perpausak
code: 02-subordinada-causal-final
unit: 01-perpausak-konplexuak
level: b1
order: 2
title: Subordinadas causales y finales (-(e)lako, -tzeko)
estimatedMinutes: 14
covers: [subord-causal, subord-final, connectors-cause]
exercises:
  - id: ex-b1-pk-02-mc1
    type: multiple-choice
    prompt: '"Ez naiz etorri lan asko nuelako" significa…'
    options:
      - "He venido porque tenía mucho trabajo"
      - "No he venido porque tenía mucho trabajo"
      - "No vine para tener mucho trabajo"
      - "Aunque tenía mucho trabajo, vine"
    answer: 1
    explanation: '*-(e)lako* = porque. *Nuelako* = porque tenía. La frase principal es negativa: "no he venido porque tenía mucho trabajo".'
  - id: ex-b1-pk-02-mc2
    type: multiple-choice
    prompt: 'Quieres decir "Vengo a ayudar". ¿Cuál es correcto?'
    options:
      - "Etortzen naiz lagundu"
      - "Lagundu etortzen naiz"
      - "Laguntzera nator"
  ...
  - id: ex-b1-pk-02-mc3
    ...
    answer: 1
    explanation: '*-(e)lako* responde a "¿por qué?" (causa). *-tzeko* responde a "¿para qué?" (finalidad).'
  - id: ex-b1-pk-02-fb1
    type: fill-in-blank
  ...
  - id: ex-b1-pk-02-fc
    ...
    cards:
      - { eu: -(e)lako, es: porque }
      - { eu: -tzeko, es: para (finalidad) }
      - { eu: -tzera, es: a (finalidad con movimiento) }
      - { eu: -tzearren, es: por (motivo) / con tal de }
      - { eu: izan ere, es: en efecto / es que }
      - { eu: zeren, es: porque (literario) }
      - { eu: hortaz, es: por tanto }
      - { eu: beraz, es: así pues }
      - { eu: ondorioz, es: por consiguiente }
      - { eu: horregatik, es: por eso }
      - { eu: zergatik?, es: ¿por qué? }
      - { eu: zertarako?, es: ¿para qué? }
---
