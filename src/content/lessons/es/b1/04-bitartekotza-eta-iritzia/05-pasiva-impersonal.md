---
id: b1-bitartekotza-5
unitId: b1-bitartekotza
code: 05-pasiva-impersonal
unit: 04-bitartekotza-eta-iritzia
level: b1
order: 5
title: Pasiva e impersonal (eraikia izan zen, hitz egiten da)
estimatedMinutes: 13
covers: [passive-construction, impersonal-da, passive-resultative]
exercises:
  - id: ex-b1-bi-05-mc1
    ...
    options:
      ...
      - "Aquí hablaré euskera"
      - "Aquí hablábamos euskera"
    answer: 1
    explanation: '*-tzen da* construye el impersonal: "se + verbo". *Hitz egiten da* = "se habla".'
  - id: ex-b1-bi-05-mc2
    type: multiple-choice
    prompt: '¿Cómo se forma el resultativo "está cerrado"?'
    options: [ixten du, itxia da, itxita dago, ireki du]
    answer: 2
    explanation: '*Partizipio + -ta + dago/daude* = resultativo: "está/n cerrado/s". *Itxita dago* = está cerrado.'
  - id: ex-b1-bi-05-mc3
    type: multiple-choice
  ...
  - id: ex-b1-bi-05-fb1
    type: fill-in-blank
    prompt: '"Aquí no se permite fumar" → Hemen ezin da ___ (fumar).'
    answers: [erre]
    explanation: '*Ezin da erre* = "no se puede fumar". *Erre* es el infinitivo/partizipio de fumar.'
  - id: ex-b1-bi-05-fb2
    type: fill-in-blank
    prompt: '"La puerta está abierta" → Atea ___ dago.'
    answers: [irekita]
    explanation: '*Irekita dago* = "está abierta". Resultativo con -ta.'
  - id: ex-b1-bi-05-fc
    type: flashcards
    cards:
      - { eu: -tzen da, es: se + verbo (impersonal) }
      - { eu: -tzen dira, es: se + verbo (plural) }
      - { eu: ezin da -, es: no se puede }
      - { eu: -ta dago, es: está + adjetivo (resultado) }
      - { eu: -ta egon, es: estar (en estado de) }
      - { eu: -(r)ik egon, es: estar (variante de -ta) }
      - { eu: -ia izan zen, es: fue + participio (pasiva) }
      - { eu: idatzia izan zen, es: fue escrito }
      - { eu: argitaratu da, es: ha sido publicado / se ha publicado }
      - { eu: itxita, es: cerrado }
      - { eu: irekita, es: abierto }
      - { eu: hautsita, es: roto }
      - { eu: bukatuta, es: terminado }
      - { eu: gertatua, es: ocurrido / ya pasado }
---
...
> *Eraikin hau eraiki**a izan zen** 1928an. Gaur egun, kultur etxe gisa erabilt**zen da**. Liburutegia astelehenetik larunbatera dago **irekita**. Asteazkenetan ez da bisitarik onar**tzen** mantentze-lanak direla eta.*
...
1. **Confundir -ta dago con -tzen da**: el primero es estado, el segundo acción habitual.
2. **Usar pasiva inglesa-style**: *eraiki izan da* en lugar de *eraikia izan da*. Necesita la -**a**.
3. **No concordar el plural**: si lo que se cierra son varias puertas, *ateak itxita daude* (no *ateak itxita dago*).
