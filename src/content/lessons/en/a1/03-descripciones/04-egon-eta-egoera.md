...
level: a1
order: 4
title: The verb egon and temporary states
estimatedMinutes: 11
covers:
- egon-nor
- mental-states
...
- id: ex-egon-mc1
  ...
  prompt: What is the form of "egon" for "I"?
  options:
  - naiz
  - nago
  - dut
  - daude
  answer: 1
  explanation: '*nago* = "I am". The verb *egon* has its own conjugation, different from *izan*.'
- id: ex-egon-mc2
  type: multiple-choice
  prompt: You want to say "I am tired". What is the natural form?
  options:
  - Ni nekatua naiz
  - Ni nekatuta nago
  - Ni nekatuan nago
  - Ni nekatua dut
  answer: 1
  explanation: For a temporary state ("today I am tired") use *egon* + *nekatuta* (without the final `-a`).
- id: ex-egon-fb1
  type: fill-in-blank
  prompt: Maialen pozik ___. (Maialen is happy)
  answers:
  - dago
  explanation: '*dago* = "is" (3rd person).'
- id: ex-egon-fb2
  type: fill-in-blank
  prompt: Gu nekatuta ___. (We are tired)
  answers:
  - gaude
  explanation: '*gaude* = "we are".'
- id: ex-egon-fc
  type: flashcards
  cards:
  - eu: nago
...
In Basque there are two verbs where English uses just one. You already know **izan** ("to be" for qualities). Now it's time for **egon**, which translates as "to be" when we talk about **temporary states**: how someone is today, right now, at this moment.
...
- **Izan** (stable quality): *I am cheerful* → *Ni alai**a** naiz.* (with `-a`)
- **Egon** (temporary state): *I am happy today* → *Ni pozik nago.* (without `-a`)
...
- **Ondo, eskerrik asko. Eta zu?** — Fine, thanks. And you?
...
> This overlaps with *izan* in a curious way: *Ni ikaslea naiz* ("I am a student" = profession, quality), but *Ni ikastetxean nago* ("I am at school" = location). In the next lesson, we'll see them in contrast.
