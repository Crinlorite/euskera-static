...
level: a1
order: 5
title: Fer a compra (lección integradora)
estimatedMinutes: 12
...
exercises:
  ...
  - id: ex-eros-fc
    ...
    cards:
      ...
      - { eu: barazkiak, es: berduras }
      - { eu: frutak, es: frutas }
      - { eu: haragia, es: carne }
      - { eu: arraina, es: peix }
      - { eu: esnea, es: leit }
      - { eu: ogia, es: pan }
      - { eu: arrautzak, es: uegos }
  - id: ex-eros-mp
    type: match-pairs
    pairs:
...
- *Ez dago ogi**rik**.* — No bi ha pan.
- *Ez daukat sagar**rik**.* — No tiengo mazanas.

> O partitivo `-rik` s'emplega siempre con cantidatz indefinidas y en negación. A forma d'o producto va sin articlo (*ogi**rik***, no *ogiarik*).
