...
level: a1
order: 4
title: Cantidatz y mesuras (neurriak)
estimatedMinutes: 10
covers:
- quantities-units
- numbers-1-100
...
- id: ex-neur-mc1
  ...
  prompt: '"Un quilo de mazanas" en euskera ye…'
  options:
  - Sagar bat
  - Kilo bat sagar
  - Bat sagar kilo
  - Kiloa bat sagar
  answer: 1
  explanation: 'En euskera la cantidat va **antis** y o producto va sin articlo: *kilo bat sagar*.'
- id: ex-neur-mc2
  type: multiple-choice
  prompt: '"Una docena de uegos" se diz…'
  options:
  - Arrautza dozena
  - Arrautza bat dozena
  - Dozena bat arrautza
  - Dozena arrautzak
  answer: 2
  explanation: '"*Dozena bat*" sigue o mesmo patrón que *kilo bat*: cantidat + producto sin articlo.'
- id: ex-neur-fb1
  type: fill-in-blank
  prompt: '"Meyo quilo de tomate" = kilo ___ tomate.'
  answers:
  - erdi
  explanation: '*Kilo erdi* — "meyo quilo". *Erdi* (meyo) va DEZAGA d''a unidat, a o revés que en aragonés.'
- id: ex-neur-fb2
  type: fill-in-blank
  prompt: '"Mas" en euskera (ta demandar un poquet mas en a botiga) = ___.'
  answers:
  - gehiago
  - Gehiago
  explanation: '*Gehiago* (mas) y *gutxiago* (menos) son os dos comparativos basicos ta regular as cantidatz.'
- id: ex-neur-fc
  type: flashcards
  cards:
  - eu: kilo bat
...
Eixemplos tipicos en a frutería:
...
- *Litro bat esne hartuko dut.* — M'en levaré un litro de leit.
- *Bi botila ur, mesedez.* — Dos botellas d'augua, per favor.

> **Nota cultural:** en mercaus (azoka) y plazas tradicionals se contina pesando tot "a güello": demandas *kilo bat sagar* y o vendedor achusta dica dar o peso chusto. Ye habitual escuitar *pixka bat gehiago, mesedez* mientres a balanza puya.
