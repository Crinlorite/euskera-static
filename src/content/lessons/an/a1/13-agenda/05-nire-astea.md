...
exercises:
  - id: ex-nast-mc1
    ...
    prompt: '"Maitín iré ta o chimnasio" =…'
    options: ['Bihar kiroldegira joan naiz', 'Bihar kiroldegira joango naiz', 'Bihar kiroldegian nago', 'Kiroldegira bihar dut']
    answer: 1
    explanation: 'Futuro: *joan + go = joango* + *naiz* (yo). *Kiroldegira* = ta o chimnasio (sufixo -ra de destín).'
  - id: ex-nast-mc2
    type: multiple-choice
    prompt: '"O sabado quedaré con Maialen ta prener café" =…'
    ...
    answer: 0
    explanation: '*Larunbatean* (o sabado) + *Maialenekin* (con Maialen) + *geratuko naiz* (quedaré) + *kafea hartzeko* (ta prener café).'
  - id: ex-nast-fb1
    type: fill-in-blank
    prompt: '"A semana que viene tendré exámens" = ___ astean azterketak izango ditut.'
    answers: [Datorren]
  ...
  - id: ex-nast-mp
    type: match-pairs
    pairs:
      - { eu: 'datorren astean', es: a semana que viene }
      - { eu: 'asteburuan', es: o cabo de semana }
      - { eu: 'bihar', es: maitín }
      - { eu: 'etzi', es: maitín de l'otro }
      - { eu: 'gaur arratsaldean', es: ista tardada }
      - { eu: 'libre nago', es: soi libre }
---

Lección final d'a unidat: imos a montar **una semana entera** chuntando tot lo aprendiu. Días, futuros, citas, marcadors de quándo... o luengache de planificar.
...
>
> O luns iré ta o chimnasio. O martes tiengo clase d'euskera. O miércols tendré una reunión. O chueves estaré tranquilo. O viernes iremos a cenar con os amigos. O cabo de semana iremos ta o mon.
...
## Mini-istoria: a semana de Iratxe

Leye ista achenda inventada y fixa-te en os marcadors temporals:
...
## A tuya vez: tres respuestas modelo
...
> **Nota cultural:** en muitos puestos veyerás cartels d'o estilo *"Asteburu honetan jaiak"* u *"Datorren ostiralean kontzertua"*. Os marcadors temporals como *datorren* y *asteburu honetan* amaneixen tanto en conversación como en cualsequier panel informativo d'o barrio. Cuan l'oído los reconoixe, leyer a carrera se torna muito més fácil.
