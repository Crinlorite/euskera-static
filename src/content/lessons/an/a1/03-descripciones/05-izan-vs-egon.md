...
level: a1
order: 5
title: Izan vs egon (cualidat vs estau)
estimatedMinutes: 11
covers: [izan-vs-egon, izan-nor, egon-nor]
exercises:
  - id: ex-ive-mc1
    type: multiple-choice
    prompt: 'Ta dir "Maialen ye alegre (en cheneral, asinas ye ella)" emplegamos…'
  ...
  - id: ex-ive-fb1
    type: fill-in-blank
    prompt: 'Mi pai ye nervioso (ye asinas) = Nire aita urduria ___.'
    answers: [da]
  ...
  - id: ex-ive-fb3
    type: fill-in-blank
    prompt: 'Estamos cansaus = Nekatuta ___.'
    answers: [gaude]
    explanation: 'Forma d''*egon* ta "nusatros" = *gaude*.'
  - id: ex-ive-fc
    type: flashcards
    cards:
