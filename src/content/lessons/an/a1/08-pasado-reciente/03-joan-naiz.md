...
level: a1
order: 3
title: Verbos intransitivos en pasau recient (joan naiz, etorri naiz)
estimatedMinutes: 12
covers:
- recent-past-naiz
- izan-nor
...
- id: ex-03-jn-mc2
  type: multiple-choice
  prompt: ¿Por qué "joan" emplega l'auxiliar naiz y no dut?
  options:
  - Porque encieta con J
  - Porque ye un verbo intransitivo (no leva obchecto)
  - Porque ye un verbo irregular
  - Porque ye un verbo d'a primera conchugación
  answer: 1
...
- id: ex-03-jn-mc3
  type: multiple-choice
  prompt: Quiers dicir "Maialen ha veniu tardi". ¿Cómo lo dices?
  options:
  ...
  answer: 1
  explanation: '*Etorri* (venir) ye intransitivo: leva *izan*. "Era" → *da*. Sin -k en o sucheto. Resultau: *Maialen berandu etorri da*.'
- id: ex-03-jn-fb1
  type: fill-in-blank
  prompt: M'he dispertau tardi = Berandu esnatu ___.
  answers:
  - naiz
  explanation: '"Esnatu" (dispertar-se) ye intransitivo: leva izan; "yo" → *naiz*.'
- id: ex-03-jn-fb2
  type: fill-in-blank
  prompt: Han iu ta o cine = Zinera joan ___.
  answers:
  - dira
  explanation: '"Joan" leva izan; "éls" → *dira*. Resultau: *haiek zinera joan dira*.'
- id: ex-03-jn-fc
  type: flashcards
  cards:
  - eu: joan naiz
  ...
  - eu: etorri naiz
    es: he veniu
  - eu: ibili naiz
    es: he caminau / he estau por astí
  - eu: esnatu naiz
    es: m'he dispertau
  - eu: jaiki naiz
    es: m'he debantau
  ...
  - eu: atera naiz
    es: he saliu
  - eu: gaixotu naiz
    es: he cayiu malauto / m'he posau malauto
  - eu: egon naiz
    es: he estau
---

Os **verbos intransitivos** son os que **no levan obchecto**: dengún *despierta bella cosa* o *va bella cosa* — uno simplement *se despierta*, *va*, *vien*. En euskera, istos verbos emplegan l'auxiliar **izan** (naiz, zara, da…). En o pasau recient a formula ye:

> **partizipioa + naiz/zara/da/gara/zarete/dira**

## A distinción clau: NOR vs NOR-NORK

Ista ye **a regla fundamental** de l'euskera y a dificultat prencipal d'ista unidat:
...
| Zu | **joan zara** | Has iu |
| Hura | **joan da** | Ha iu |
| Gu | **joan gara** | Hemos iu |
| Zuek | **joan zarete** | Habez iu |
| Haiek | **joan dira** | Han iu |

> Os pronombres aquí van **sin -k** (van con NOR, no con NORK): *ni*, no *nik*; *Maialen*, no *Maialenek*. En iste patrón os nombres propios van tal cual: *Egoitz etorri da* (Egoitz ha veniu), *Maialen joan da* (Maialen ha iu).

## Comparanza costau a costau

| Intransitivo (NAIZ) | Transitivo (DUT) |
|---|---|
| *joan naiz* (he iu) | *eraman dut* (he levau) |
| *etorri naiz* (he veniu) | *ekarri dut* (he traíto) |
| *esnatu naiz* (m'he dispertau) | *esnatu dut umea* (he dispertau a o ninón) |
| *jaiki naiz* (m'he debantau) | *jaso dut* (he replegau) |

> Bels verbos pueden ser intransitivos **o** transitivos seguntes o contexto: *esnatzen naiz* = me dispierto; *umea esnatu dut* = he dispertau a o ninón. En A1 centra-te en as parellas más comuns.
...
- *Etxera oinez etorri naiz.* — He veniu ta casa a piet.
- *Egoitz berandu jaiki da gaur.* — Egoitz s'ha debantau tardi hue.
- *Gu zinera joan gara.* — Nusatros hemos iu ta o cine.
- *Haiek tabernan egon dira.* — Éls han estau en a taberna.

## Negación

> *Ez naiz lanera joan.* — No he iu ta o treballo.
>
> *Ez da etorri.* — No ha veniu.
>
> *Ez gara goiz esnatu.* — No mos hemos dispertau luego.
...
Fixa-te cómo cambia l'auxiliar entre verbos: *joan **naiz*** (intransitivo) vs *bazkaldu **dut*** (transitivo). Ye a coreografía constant de l'euskera.
