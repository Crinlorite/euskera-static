...
level: a1
order: 5
title: Conta o tuyo día de hue (lición integradora)
estimatedMinutes: 12
...
exercises:
  ...
  - id: ex-05-gze-mc2
    ...
    options:
      ...
      - "Ye una error, habría d'estar nomás Mikel"
    answer: 1
    explanation: 'En euskera o subchecto d''os verbos transitivos leva a marca NORK (-k): Mikel**ek** ha leyiu o periodico.'
  - id: ex-05-gze-fb1
    type: fill-in-blank
    prompt: 'He almorzau tostadas y café = Tostadak eta kafea ___ ___ (replena: partizipio + auxiliar ta "yo").'
    answers: ['hartu ditut', 'jan ditut']
    explanation: 'Ta "prener/minchar quantas cosas" s''emplega *ditut* (auxiliar plural d''ukan): *hartu/jan ditut*.'
  - id: ex-05-gze-fb2
    type: fill-in-blank
    prompt: 'He iu ta o euskaltegi a piet = Euskaltegira oinez ___ ___ (replena: partizipio + auxiliar).'
    answers: ['joan naiz']
    explanation: '"Joan" intransitivo + "naiz" ta 1ª persona = "joan naiz".'
  - id: ex-05-gze-fc
    type: flashcards
    cards:
      ...
      - { eu: Arratsaldean kafea hartu dut, es: De tardi he prenso café }
      - { eu: Buelta bat eman dut, es: He feito una volteta }
      - { eu: Erosketak egin ditut, es: He feito a compra }
      - { eu: Etxera bueltatu naiz, es: He tornau ta casa }
      - { eu: Telebista ikusi dut, es: He veyiu a tele }
      - { eu: Hamaiketan oheratu naiz, es: M'he gitau a las onze }
      - { eu: Lasai egon naiz, es: He estau tranquilo/a }
      - { eu: Asko ikasi dut, es: He aprendiu muito }
---
...
1. **Quán t'has dispertau** → *Gaur ___etan esnatu naiz.*
2. **Qué has feito de maitín** → *Goizean ...*
3. **Cómo has iu ta bell puesto** → *Lanera / euskaltegira oinez / autoz / autobusez joan naiz.*
4. **Qué has minchau / bebiu** → *Bazkaltzeko ___ jan dut. ___ edan dut.*
5. **Qué has feito de tardi** → *Arratsaldean ...*
6. **Quán y cómo t'has gitau** → *Gauean ___etan oheratu naiz.*
