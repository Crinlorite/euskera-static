...
| Travail | *Bera**k ospitalean lan egiten du**.* — Il/elle travaille à l'hôpital. |
...
| Lieu | Phrase |
|---|---|
| ospitala (hôpital) | *ospitale**an** lan egiten du* |
| eskola (école) | *eskola**n** lan egiten du* |
| taberna (bar) | *taberna**n** lan egiten du* |
| bulegoa (bureau) | *bulego**an** lan egiten du* |
| denda (magasin) | *denda**n** lan egiten du* |
| euskaltegia (école de basque) | *euskaltegi**an** lan egiten du* |
| etxean (à la maison) | *etxean lan egiten du* |

> Souviens-toi : si le mot se termine par un `-a` organique (tabern**a**), il se conserve → *tabernan*. S'il se termine par une consonne (Madril), on intercale un `-e-` → *Madrilen*.
