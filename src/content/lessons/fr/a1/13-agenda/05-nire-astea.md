...
level: a1
order: 5
title: Ma semaine (leçon de synthèse)
estimatedMinutes: 12
covers: [weekly-planning, future-koGo, time-when, days-of-week, common-verbs]
exercises:
  - id: ex-nast-mc1
    type: multiple-choice
    prompt: '« Demain j''irai à la salle de sport » =…'
    options: ['Bihar kiroldegira joan naiz', 'Bihar kiroldegira joango naiz', 'Bihar kiroldegian nago', 'Kiroldegira bihar dut']
    answer: 1
    explanation: 'Futur : *joan + go = joango* + *naiz* (je). *Kiroldegira* = à la salle de sport (suffixe -ra de destination).'
  - id: ex-nast-mc2
    type: multiple-choice
    prompt: '« Samedi, je retrouverai Maialen pour prendre un café » =…'
    ...
    answer: 0
    explanation: '*Larunbatean* (le samedi) + *Maialenekin* (avec Maialen) + *geratuko naiz* (je retrouverai / je donnerai rendez-vous) + *kafea hartzeko* (pour prendre un café).'
  - id: ex-nast-fb1
    type: fill-in-blank
    prompt: '« La semaine prochaine j''aurai des examens » = ___ astean azterketak izango ditut.'
    answers: [Datorren]
    explanation: '*Datorren* — « qui vient / prochain(e) ». *Datorren astean* — « la semaine prochaine ».'
  - id: ex-nast-fb2
    type: fill-in-blank
    prompt: '« Vendredi je sortirai avec les amis » = Ostiralean lagunekin atera___ naiz.'
    answers: [ko]
    explanation: '*Atera* + *ko* + *naiz* = *aterako naiz* (je sortirai). Verbe en -a → -ko.'
  - id: ex-nast-fc
    type: flashcards
    cards:
      - { eu: agenda, es: agenda }
      - { eu: 'Asteko agenda', es: Agenda de la semaine }
      - { eu: 'Zer egingo duzu astelehenean?', es: Que feras-tu lundi ? }
      - { eu: 'Kiroldegira joango naiz', es: J'irai à la salle de sport }
      - { eu: 'Lagunekin afaltzera joango gara', es: Nous irons dîner avec les amis }
      - { eu: 'Asteburu honetan mendira joango gara', es: Ce week-end nous irons à la montagne }
      - { eu: 'Datorren astean lan asko izango dut', es: La semaine prochaine j'aurai beaucoup de travail }
      - { eu: 'Ostiralean parranda egingo dugu', es: Vendredi nous ferons la fête }
      - { eu: 'Bilera dut hamarretan', es: J'ai une réunion à dix heures }
      - { eu: 'Libre zaude?', es: 'Es-tu libre ?' }
      - { eu: 'Geratuko gara?', es: 'On se voit ?' }
  - id: ex-nast-mp
    type: match-pairs
    pairs:
      - { eu: 'datorren astean', es: la semaine prochaine }
      - { eu: 'asteburuan', es: le week-end }
      - { eu: 'bihar', es: demain }
      - { eu: 'etzi', es: après-demain }
      - { eu: 'gaur arratsaldean', es: cet après-midi }
      - { eu: 'libre nago', es: je suis libre }
---
...
| Verbe | Forme future | Français |
|---|---|---|
| joan | joango naiz/da | j'irai, il/elle ira |
| etorri | etorriko naiz/da | je viendrai, il/elle viendra |
| egon | egongo naiz | je serai |
| izan | izango da | il/elle sera / il y aura |
| ikusi | ikusiko dut | je (le) verrai |
| egin | egingo dut | je (le) ferai |
| jan | jango dut | je (le) mangerai |
| lan egin | lan egingo dut | je travaillerai |
| atera | aterako naiz | je sortirai |
| eraman | eramango dut | je (l')emporterai |
| erosi | erosiko dut | je (l')achèterai |
