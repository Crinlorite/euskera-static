...
level: a1
order: 3
title: Moments de la journée (goizean, arratsaldean, gauean)
estimatedMinutes: 10
covers: [parts-of-day, time-expressions, locative-non]
exercises:
  - id: ex-03-em-mc1
    type: multiple-choice
    prompt: '« Goizean » signifie…'
    options: ["le soir", "le matin", "à midi", "tout de suite"]
    answer: 1
    explanation: '« Goiz » = matin ; avec le locatif « -an » : « le matin ».'
  - id: ex-03-em-mc2
    type: multiple-choice
    prompt: 'Tu veux dire « à huit heures du matin ». Comment le dis-tu ?'
    options: ["zortziak goizean", "goizeko zortziak", "goiz zortziak", "zortzi goizeko"]
    answer: 1
    explanation: 'Pour préciser matin/après-midi, on antépose la partie de la journée avec le suffixe « -ko » : *goizeko zortziak* (huit heures du matin).'
  - id: ex-03-em-fb1
    type: fill-in-blank
    prompt: 'L''après-midi = ___ (complète le mot entier).'
    answers: [arratsaldean, Arratsaldean]
    explanation: '« Arratsalde » = après-midi ; avec le locatif « -(e)an » : *arratsaldean* (l''après-midi).'
  - id: ex-03-em-fb2
    type: fill-in-blank
    prompt: 'La nuit = ___ (complète le mot entier).'
    answers: [gauean, Gauean]
    explanation: '« Gau » = nuit ; avec le locatif « -an » : *gauean*.'
  - id: ex-03-em-mp
    type: match-pairs
    pairs:
      - { eu: goizean, es: le matin }
      - { eu: eguerdian, es: à midi }
      - { eu: arratsaldean, es: l'après-midi }
      - { eu: iluntzean, es: au crépuscule }
      - { eu: gauean, es: la nuit }
      - { eu: gaur, es: aujourd'hui }
      - { eu: bihar, es: demain (le lendemain) }
      - { eu: atzo, es: hier }
  - id: ex-03-em-fc
    type: flashcards
    cards:
      - { eu: goiza, es: le matin }
      - { eu: eguerdia, es: le midi }
      - { eu: arratsaldea, es: l'après-midi }
      - { eu: iluntzea, es: le crépuscule }
      - { eu: gaua, es: la nuit }
      - { eu: goizean, es: le matin }
      - { eu: eguerdian, es: à midi }
      - { eu: arratsaldean, es: l'après-midi }
      - { eu: iluntzean, es: au crépuscule }
      - { eu: gauean, es: la nuit }
      - { eu: goizeko zortziak, es: huit heures du matin }
      - { eu: arratsaldeko hirurak, es: trois heures de l'après-midi }
      - { eu: gaueko hamarrak, es: dix heures du soir }
      - { eu: gaur, es: aujourd'hui }
      - { eu: atzo, es: hier }
      - { eu: bihar, es: demain (le lendemain) }
---
