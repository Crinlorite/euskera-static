...
level: a1
order: 2
title: Et demie, et quart, moins (eta erdiak, eta laurden, gutxi)
estimatedMinutes: 12
covers:
- time-detail
- time-basics
...
- id: ex-02-ee-mc1
  ...
  prompt: Il est cinq heures et demie. Comment le dis-tu en basque ?
  options:
  - Bost eta erdi da
  ...
  - Bost erdi
  answer: 1
  explanation: 'Pour « et demie » on utilise « eta erdiak » (littéralement « et demies », aussi au pluriel). Le nombre se met sans « -ak » devant « eta erdiak » : « bost eta erdiak ».'
- id: ex-02-ee-mc2
  type: multiple-choice
  prompt: Il est trois heures et quart. Comment le dis-tu ?
  options:
  - Hiruak eta laurden
  ...
  - Hiru eta laurdenak
  answer: 2
  explanation: '« Eta laurden » signifie « et quart » ; l''heure se met au pluriel (« hirurak ») : *Hirurak eta laurden dira*.'
- id: ex-02-ee-mc3
  type: multiple-choice
  prompt: Il est neuf heures moins le quart. Comment le dis-tu ?
  options:
  ...
  answer: 0
  explanation: 'En basque, « moins » se dit « gutxi » et se place derrière. Littéralement : « les neuf quart moins ».'
- id: ex-02-ee-fb1
  type: fill-in-blank
  prompt: Il est sept heures cinq = Zazpiak eta ___ dira.
  answers:
  - bost
  explanation: Les minutes passées se disent avec « eta + nombre ». Cinq = bost.
- id: ex-02-ee-fb2
  type: fill-in-blank
  prompt: Il est quatre heures moins dix = Laurak hamar ___ dira.
  answers:
  - gutxi
  explanation: « Gutxi » signifie « moins » dans les expressions de l'heure.
- id: ex-02-ee-fc
  type: flashcards
  cards:
  - eu: eta erdiak
    es: et demie (3:30 = hiru eta erdiak)
  - eu: eta laurden
    es: et quart (3:15 = hirurak eta laurden)
  - eu: laurden gutxi
    es: moins le quart (2:45 = hirurak laurden gutxi)
  - eu: gutxi
    es: moins (dans les expressions de l'heure)
  - eu: Bostak eta erdiak dira
    es: Il est cinq heures et demie
  - eu: Hirurak eta laurden dira
    es: Il est trois heures et quart
  - eu: Bederatziak laurden gutxi dira
    es: Il est neuf heures moins le quart
  - eu: Hamarrak eta hamar dira
    es: Il est dix heures dix
  - eu: Zortziak hamar gutxi dira
    es: Il est huit heures moins dix
  - eu: Sei eta erdiak dira
    es: Il est six heures et demie
---

Pour les minutes en basque, il y a trois constructions qui couvrent presque tout : **eta erdiak** (et demie), **eta laurden** (et quart) et **gutxi** (moins). L'astuce, c'est de savoir où placer chaque chose.
