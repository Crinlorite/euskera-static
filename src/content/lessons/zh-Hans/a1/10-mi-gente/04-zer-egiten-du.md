...
- id: ex-10-04-mc1
  ...
  answer: 0
  explanation: “Ospitalean” = 在医院（位格 -ean），“lan egiten du” = 工作（第三人称）。
- id: ex-10-04-fb1
  type: fill-in-blank
  prompt: 住在潘普洛纳 = Iruñean ___ da。
  answers:
  - bizi
  explanation: “Bizi da” = 住（字面意思：“正在生活”）。第一人称是“bizi naiz”。
- id: ex-10-04-mc2
  type: multiple-choice
  prompt: “Bera euskaltegian lan egiten du” —— 哪种职业最合适？
  options:
  - sukaldaria
  - irakaslea
  - mekanikaria
  - zerbitzaria
  answer: 1
  explanation: 如果某人在 euskaltegi（巴斯克语学校）工作，最有可能是教师（irakaslea）。
- id: ex-10-04-fb2
  type: fill-in-blank
  prompt: 他/她40岁 = Berrogei urte ___。
  answers:
  - ditu
  explanation: “Ditu” = 有（第三人称，复数宾语——年龄用复数计数）。
- id: ex-10-04-fc
  type: flashcards
  cards:
  - eu: Zer egiten du?
...
一旦你会介绍某个人（*Hau X da*），下一个自然的步骤就是**讲述这个人做什么**：住在哪里、在哪里工作、几岁、日常生活是怎样的。所有的动词变位都用**第三人称**，所以这里我们就练习这一点。
...
| 主题 | 典型句子 |
|---|---|
| 居住 | *Bera **Iruñean bizi da**.* —— 他/她住在潘普洛纳。 |
| 同住 | *Bera **bikotekidearekin bizi da**.* —— 他/她和伴侣一起住。 |
| 年龄 | *Bera**k hogeita hamar urte ditu**.* —— 他/她30岁。 |
| 职业 | *Bera **medikua da**.* —— 他/她是医生。 |
| 工作 | *Bera**k ospitalean lan egiten du**.* —— 他/她在医院工作。 |
...
| 地点 | 句子 |
|---|---|
| ospitala (医院) | *ospitale**an** lan egiten du* |
| eskola (学校) | *eskola**n** lan egiten du* |
| taberna (酒吧) | *taberna**n** lan egiten du* |
| bulegoa (办公室) | *bulego**an** lan egiten du* |
| denda (商店) | *denda**n** lan egiten du* |
| euskaltegia (巴斯克语学校) | *euskaltegi**an** lan egiten du* |
| etxean (在家) | *etxean lan egiten du* |

> 记住：如果单词以固有的`-a`结尾（tabern**a**），它会保留 → *tabernan*。如果以辅音结尾（Madril），就插入`-e-` → *Madrilen*。
...
> 对于A1水平，零散的句子就足够了；不需要把一整天串联起来。如果你能清楚地说出一位邻居的三件事，那你已经把他介绍得很不错了。
