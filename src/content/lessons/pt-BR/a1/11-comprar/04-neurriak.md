...
level: a1
order: 4
title: Quantidades e medidas (neurriak)
estimatedMinutes: 10
covers:
- quantities-units
- numbers-1-100
...
- id: ex-neur-mc1
  ...
  prompt: '"Um quilo de maçãs" em euskera é…'
  options:
  - Sagar bat
  - Kilo bat sagar
  - Bat sagar kilo
  - Kiloa bat sagar
  answer: 1
  explanation: 'Em euskera a quantidade vai **antes** e o produto vai sem artigo: *kilo bat sagar*.'
- id: ex-neur-mc2
  type: multiple-choice
  prompt: '"Uma dúzia de ovos" se diz…'
  options:
  - Arrautza dozena
  - Arrautza bat dozena
  - Dozena bat arrautza
  - Dozena arrautzak
  answer: 2
  explanation: '"*Dozena bat*" segue o mesmo padrão que *kilo bat*: quantidade + produto sem artigo.'
- id: ex-neur-fb1
  type: fill-in-blank
  prompt: '"Meio quilo de tomate" = kilo ___ tomate.'
  answers:
  - erdi
  explanation: '*Kilo erdi* — "meio quilo". *Erdi* (meio) vai **DEPOIS** da unidade, ao contrário do português.'
- id: ex-neur-fb2
  type: fill-in-blank
  prompt: '"Mais" em euskera (para pedir um pouco mais na loja) = ___.'
  answers:
  - gehiago
  - Gehiago
  explanation: '*Gehiago* (mais) e *gutxiago* (menos) são os dois comparativos básicos para regular quantidades.'
- id: ex-neur-fc
  type: flashcards
  cards:
  - eu: kilo bat
...
> **Nota cultural:** em mercados (azoka) e feiras tradicionais, ainda se pesa tudo "a olho": você pede *kilo bat sagar* e o vendedor ajusta até dar o peso certo. É comum ouvir *pixka bat gehiago, mesedez* enquanto a balança sobe.
