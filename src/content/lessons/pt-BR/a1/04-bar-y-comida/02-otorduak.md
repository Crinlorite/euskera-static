...
level: a1
order: 2
title: Refeições do dia (otorduak)
estimatedMinutes: 10
covers: [meals]
exercises:
  - id: ex-otr-mc1
    ...
    options: [o café da manhã, a refeição do meio-dia, o lanche, o jantar]
    answer: 1
    explanation: '*bazkaria* é a refeição principal do meio-dia.'
  - id: ex-otr-mc2
    type: multiple-choice
    prompt: 'Como se diz "o almoço do meio da manhã" (a pausa das 11)?'
    options: [gosaria, hamaiketakoa, bazkaria, afaria]
    answer: 1
    explanation: '*hamaiketakoa* (literal: "o das onze") é esse almoço do meio da manhã, costume bem basco.'
  - id: ex-otr-fb1
    type: fill-in-blank
    prompt: 'Comer (verbo) = ___.'
    answers: [jan]
    explanation: '*jan* = comer. Forma básica do infinitivo.'
  - id: ex-otr-fb2
    type: fill-in-blank
  ...
  - id: ex-otr-fc
    type: flashcards
    cards:
      - { eu: gosaria, es: o café da manhã }
      - { eu: hamaiketakoa, es: o almoço do meio da manhã }
      - { eu: bazkaria, es: a refeição (do meio-dia) }
      - { eu: askaria, es: o lanche }
      - { eu: afaria, es: o jantar }
      - { eu: otordua, es: a refeição (genérico) }
      - { eu: jan, es: comer }
      - { eu: edan, es: beber }
      - { eu: gosaldu, es: tomar o café da manhã }
      - { eu: bazkaldu, es: almoçar (ao meio-dia) }
      - { eu: afaldu, es: jantar }
      - { eu: gose naiz, es: estou com fome }
      - { eu: egarri naiz, es: estou com sede }
  - id: ex-otr-mp
    type: match-pairs
    pairs:
      - { eu: gosaria, es: café da manhã }
      - { eu: hamaiketakoa, es: almoço do meio da manhã }
      - { eu: bazkaria, es: refeição do meio-dia }
      - { eu: askaria, es: lanche }
      - { eu: afaria, es: jantar }
      - { eu: jan, es: comer }
      - { eu: edan, es: beber }
---
