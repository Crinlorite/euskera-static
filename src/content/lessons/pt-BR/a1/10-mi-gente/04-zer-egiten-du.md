...
| Idade | *Bera**k hogeita hamar urte ditu**.* — Tem 30 anos. |
| Profissão | *Bera **medikua da**.* — É médico(a). |
| Trabalho | *Bera**k ospitalean lan egiten du**.* — Trabalha no hospital. |
...
| bulegoa (escritório) | *bulego**an** lan egiten du* |
| denda (loja) | *denda**n** lan egiten du* |
