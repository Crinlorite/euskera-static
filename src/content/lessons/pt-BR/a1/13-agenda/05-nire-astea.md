...
level: a1
order: 5
title: Minha semana (lição integradora)
estimatedMinutes: 12
covers: [weekly-planning, future-koGo, time-when, days-of-week, common-verbs]
exercises:
  - id: ex-nast-mc1
    type: multiple-choice
    prompt: '"Amanhã irei à academia" =…'
    options: ['Bihar kiroldegira joan naiz', 'Bihar kiroldegira joango naiz', 'Bihar kiroldegian nago', 'Kiroldegira bihar dut']
    answer: 1
    explanation: 'Futuro: *joan + go = joango* + *naiz* (eu). *Kiroldegira* = à academia (sufixo -ra de destino).'
  - id: ex-nast-mc2
    type: multiple-choice
    prompt: '"No sábado vou encontrar a Maialen para tomar um café" =…'
    ...
    answer: 0
    explanation: '*Larunbatean* (no sábado) + *Maialenekin* (com a Maialen) + *geratuko naiz* (vou encontrar) + *kafea hartzeko* (para tomar um café).'
  - id: ex-nast-fb1
    type: fill-in-blank
    prompt: '"Na semana que vem terei provas" = ___ astean azterketak izango ditut.'
    answers: [Datorren]
    explanation: '*Datorren* — "que vem". *Datorren astean* — "na semana que vem".'
  - id: ex-nast-fb2
    type: fill-in-blank
    prompt: '"Na sexta-feira vou sair com os amigos" = Ostiralean lagunekin atera___ naiz.'
    answers: [ko]
    explanation: '*Atera* + *ko* + *naiz* = *aterako naiz* (vou sair). Verbo em -a → -ko.'
  - id: ex-nast-fc
    type: flashcards
    cards:
      - { eu: agenda, es: agenda }
      - { eu: 'Asteko agenda', es: Agenda da semana }
      - { eu: 'Zer egingo duzu astelehenean?', es: O que você vai fazer na segunda-feira? }
      - { eu: 'Kiroldegira joango naiz', es: Vou à academia }
      - { eu: 'Lagunekin afaltzera joango gara', es: Vamos jantar com os amigos }
      - { eu: 'Asteburu honetan mendira joango gara', es: Neste fim de semana vamos para a montanha }
  ...
  - id: ex-nast-mp
    type: match-pairs
    pairs:
      - { eu: 'datorren astean', es: na semana que vem }
      - { eu: 'asteburuan', es: no fim de semana }
      - { eu: 'bihar', es: amanhã }
      - { eu: 'etzi', es: depois de amanhã }
      - { eu: 'gaur arratsaldean', es: esta tarde }
      - { eu: 'libre nago', es: estou livre }
---
...
| Verbo | Forma futura | Português |
|---|---|---|
| joan | joango naiz/da | irei, irá |
| etorri | etorriko naiz/da | virei, virá |
| egon | egongo naiz | estarei |
| izan | izango da | será / haverá |
| ikusi | ikusiko dut | (o) verei |
| egin | egingo dut | (o) farei |
| jan | jango dut | (o) comerei |
| lan egin | lan egingo dut | trabalharei |
