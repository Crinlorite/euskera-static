...
> Muitos desses adjetivos vêm de um substantivo + sufixo. Por exemplo *langile* vem de *lan* ("trabalho"); *beldurti* vem de *beldur* ("medo"). Você não precisa aprender a lógica interna no A1, mas isso vai te ajudar a memorizar.

## Estrutura: igual aos físicos

- *Maialen oso **alaia** da.* — Maialen é muito alegre.
- *Egoitz **isila eta serioa** da.* — Egoitz é calado e sério.
- *Gu **langileak** gara.* — Nós somos trabalhadores.
- *Haiek **bihurriak** dira.* — Eles são travessos.
- *Ni ez naiz oso **lotsatia**.* — Eu não sou muito tímida.
...
>
> Minha irmã é alegre, simpática e trabalhadora.

## "Oso" e "nahiko" para matizar

- **oso** alaia → muito alegre
- **nahiko** isila → bastante calada
- **ez** oso urduria → não muito nervosa
- **ez** zara batere alferra → você não é nada preguiçosa (*batere* reforça a negação)
