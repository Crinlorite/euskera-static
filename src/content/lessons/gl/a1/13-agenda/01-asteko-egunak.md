...
level: a1
order: 1
title: Días da semana e actividades
estimatedMinutes: 9
covers:
- days-of-week
- common-verbs
...
- id: ex-eg-mc1
  ...
  - igandea
  answer: 0
  explanation: '*Astelehena* — primeiro día da semana (literalmente "primeiro-día-da-semana").'
- id: ex-eg-mc2
  type: multiple-choice
  prompt: Que día é "asteburua"?
  options:
  - luns
  - martes
  ...
  - mércores
  answer: 2
  explanation: '*Asteburua* — fin de semana, literal "a fin de semana".'
- id: ex-eg-fb1
  type: fill-in-blank
  prompt: '"Vou ao ximnasio o luns" = ___ kiroldegira noa.'
  answers:
  - Astelehenean
  - astelehenean
  explanation: '*-(e)an* nos días = "o". *Astelehenean* — "o luns".'
- id: ex-eg-fb2
  type: fill-in-blank
  prompt: '"Todos os luns" = ___'
  answers:
  - astelehenero
  - Astelehenero
  explanation: 'O sufixo *-ero* indica "cada / todos os": *astelehenero* = "todos os luns".'
- id: ex-eg-fc
  type: flashcards
  cards:
  - eu: astelehena
...
| Éuscaro | Galego | Pista |
|---|---|---|
| *astelehena* | luns | aste + lehen = "primeiro día da semana" |
| *asteartea* | martes | aste + arte = "entre semana" |
| *asteazkena* | mércores | aste + azken = "último día da semana laboral" (hist.) |
| *osteguna* | xoves | egun = día |
| *ostirala* | venres | comparte a raíz *ortzi/osti-* (ceo) con *osteguna* |
...
| Éuscaro | Galego |
|---|---|
| *Astelehenean kiroldegira noa.* | O luns vou ao ximnasio. |
| *Asteartean euskara klasea dut.* | O martes teño clase de éuscaro. |
| *Ostiralean parranda egiten dugu.* | O venres saímos de troula. |
| *Larunbatean familiaren etxera joango naiz.* | O sábado irei á casa da familia. |
| *Igandean lasai gelditzen naiz etxean.* | O domingo quedo tranquilo na casa. |
