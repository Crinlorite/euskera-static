...
level: a1
order: 4
title: Cantidades e medidas (neurriak)
estimatedMinutes: 10
covers:
- quantities-units
- numbers-1-100
...
- id: ex-neur-mc1
  ...
  prompt: '"Un quilo de mazás" en éuscaro é…'
  options:
  - Sagar bat
  - Kilo bat sagar
  - Bat sagar kilo
  - Kiloa bat sagar
  answer: 1
  explanation: 'En éuscaro a cantidade vai **antes** e o produto vai sen artigo: *kilo bat sagar*.'
- id: ex-neur-mc2
  type: multiple-choice
  prompt: '"Unha ducia de ovos" dise…'
  options:
  - Arrautza dozena
  - Arrautza bat dozena
  - Dozena bat arrautza
  - Dozena arrautzak
  answer: 2
  explanation: '"*Dozena bat*" segue o mesmo patrón que *kilo bat*: cantidade + produto sen artigo.'
- id: ex-neur-fb1
  type: fill-in-blank
  prompt: '"Medio quilo de tomate" = kilo ___ tomate.'
  answers:
  - erdi
  explanation: '*Kilo erdi* — "medio quilo". *Erdi* (medio) vai DETRÁS da unidade, ao revés que en galego.'
- id: ex-neur-fb2
  type: fill-in-blank
  prompt: '"Máis" en éuscaro (para pedir un pouco máis na tenda) = ___.'
  answers:
  - gehiago
  - Gehiago
  explanation: '*Gehiago* (máis) e *gutxiago* (menos) son os dous comparativos básicos para regular cantidades.'
- id: ex-neur-fc
  type: flashcards
  cards:
  - eu: kilo bat
...
Saber pedir cantidades concretas é a diferenza entre "unha mazá" e "un quilo de mazás". O patrón en éuscaro é moi regular e sempre o mesmo.
